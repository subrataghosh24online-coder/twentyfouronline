...
return [
    ...
    'dev:check' => [
        'description' => 'Перевірки коду twentyfouronline. Запуск без опцій запускає всі перевірки',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'Ім\'я файлу snmprec який необхідно оновити або додати до twentyfouronline. Якщо файл не вказано, пристрій не буде додано або оновлено.',
        ],
        'options' => [
    ...
    'smokeping:generate' => [
        ...
        'header-third' => 'Для додаткової інформації див. https://docs.twentyfouronline.org/Extensions/Smokeping/"',
