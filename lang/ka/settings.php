    ...
    'settings' => [
        'active_directory' => [
            'users_purge' => [
                ...
                'help' => 'მომხმარებლები წაიშლება twentyfouronline-დან ამდენი დღის შემდეგ შესვლის გარეშე. 0 ნიშნავს არასდროს და მომხმარებლები აღდგება, თუ ისინი კვლავ შევლენ სისტემაში.',
            ],
        ],
        ...
        'distributed_poller' => [
            ...
            'help' => 'განაწილებული გამოთხოვის ჩართვა მთელ სისტემაში. ეს განკუთვნილია დატვირთვის გაზიარებისთვის და არა დაშორებული გამოთხოვისთვის. დოკუმენტაცია ნაბიჯებისთვის, რომ ჩართოთ ის: https://docs.twentyfouronline.org/Extensions/Distributed-Poller/',
        ],
        ...
        'mydomain' => [
            ...
            'help' => 'ეს დომენი გამოიყენება ქსელური ავტოაღმოჩენისთვის და სხვა პროცესებისთვის. twentyfouronline სცდის, დაუსრულებელ ჰოსტის სახელებს ეს მიაწეროს.',
        ],
        ...
        'own_hostname' => [
            'description' => 'twentyfouronline-ის ჰოსტის სახელი',
            'help' => 'უნდა დააყენოთ ჰოსტის სახელზე/IP მისამართზე, რომელზეც დამატებულია twentyfouronline სერვერი',
        ],
        'oxidized' => [
            'default_group' => [
            ...
            'ignore_os' => [
                ...
                'help' => 'არ მოხდება ჩამოთვლილი ოს-ების მარქაფი Oxidized-თ. ოს უნდა ემთხვეოდეს twentyfouronline-ის ოს-ის სახელს (ეს ყველა პატარა ასოებით, ჰარეების გარეშე).  მხოლოდ დაუშვებს არსებულ ოს-ს.',
            ],
            'ignore_types' => [
        ...
        'autodiscovery' => [
            ...
            'xdp' => [
                ...
                'help' => 'LLDP, CDP და სხვა პროტოკოლების გამოყენება ქსელის ტოპოლოგიის და მეზობლების აღმოსაჩენად და მათი twentyfouronline-ში დასამატებლად',
            ],
            'xdp_exclude' => [
                'sysname_regexp' => [
        ...
        'reporting' => [
            'error' => [
                ...
                'help' => 'ზოგიერთი შეცდომის გაგზავნა twentyfouronline-სთვის ანალიზისა და გასწორებისთვის',
            ],
            'usage' => [
                'description' => 'გამოყენების ანგარიშების გაგზავნა',
                'help' => 'გამოყენების და ვერსიების გაგზავნა twentyfouronline-სთვის. ანონიმური სტატისტიკის წასაშლელად ეწვიეთ გვერდს "შესახებ". სტატისტიკის ნახვა შეგიძლიათ მისამართზე https://stats.twentyfouronline.org',
            ],
            'dump_errors' => [
        ...
        'rrd_dir' => [
            ...
            'help' => 'rrd ფაილების მდებარეობა.  ნაგულისხმევია rrd twentyfouronline-ის საქაღალდის შიგნით. ამ პარამეტრის ცვლილება rrd ფაილებს არ გადაიტანს.',
        ],
        'rrd_purge' => [
        ...
        'rrdtool_version' => [
            ...
            'help' => 'ყველაფერს, რაც 1.5.5-ზე ახალია, აქვს ყველა ის ფუნქცია, რასაც twentyfouronline იყენებთ, ნუ დააყენებთ სისტემაში არსებულ ვერსიაზე უფრო მაღალზე',
        ],
        'schedule_type' => [
            'alerting' => [
        ...
        'service_watchdog_log' => [
            ...
            'help' => 'ნაგულისხმევი მნიშვნელობაა twentyfouronline-ის ჟურნალის ფაილი. აყენებს ნაგულისხმევ მნიშვნელობას ყველა კვანძისთვის.',
        ],
        'service_health_file' => [
