...
$descr = \twentyfouronline\Data\Store\Rrd::safeDescr(substr(str_pad($toner['supply_descr'], 26), 0, 26));

$background = \twentyfouronline\Util\Color::percentage(100 - $toner['supply_current']);
