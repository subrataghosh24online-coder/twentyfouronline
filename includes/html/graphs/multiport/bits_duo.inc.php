...
$rrd_options .= \App\Facades\twentyfouronlineConfig::get('rrdgraph_def_text') . ' -c FONT#' . ltrim(\App\Facades\twentyfouronlineConfig::get('rrdgraph_def_text_color'), '#');
if ($height < '99') {
...
if ($width <= '300') {
    $rrd_options .= ' --font LEGEND:7:' . \App\Facades\twentyfouronlineConfig::get('mono_font') . ' --font AXIS:6:' . \App\Facades\twentyfouronlineConfig::get('mono_font') . ' --font-render-mode normal';
}
