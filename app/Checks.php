...
class Checks
{
    ...
    public static function postAuth()
    {
        ...
        Cache::put('checks_popup_timeout', true, twentyfouronlineConfig::get('checks_popup_timer', 5) * 60);
        ...
        if ($user->isAdmin()) {
            ...
            $warn_sec = twentyfouronlineConfig::get('rrd.step', 300) * 3;
            ...
            $temp_dir = twentyfouronlineConfig::get('temp_dir');
            if (! is_dir($temp_dir)) {
