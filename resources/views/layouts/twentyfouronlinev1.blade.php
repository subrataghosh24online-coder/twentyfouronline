...
<head>
    ...
    <base href="{{ twentyfouronlineConfig::get('base_url') }}">
    <meta http-equiv="content-type" content="text/html; charset=utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    @if(!twentyfouronlineConfig::get('favicon', false))
    ...
    @else
        <link rel="shortcut icon" href="{{ twentyfouronlineConfig::get('favicon') }}">
    @endif
    ...
    <link href="{{ asset(twentyfouronlineConfig::get('stylesheet', 'css/styles.css')) }}?ver=25052501" rel="stylesheet">
    ...
    @endif
    @foreach(twentyfouronlineConfig::get('webui.custom_css', []) as $custom_css)
    ...
    <script src="{{ asset('js/twentyfouronline.js?ver=30062025') }}"></script>
