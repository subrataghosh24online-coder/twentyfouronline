...
namespace twentyfouronline\Tests\Feature\Commands;

use App\Facades\twentyfouronlineConfig;
use twentyfouronline\Tests\InMemoryDbTestCase;
...
class TestConfigCommands extends InMemoryDbTestCase
{
    ...
    {
        // simple
        twentyfouronlineConfig::set('login_message', null);
        $this->assertCliSets('login_message', 'hello');

        // nested
        twentyfouronlineConfig::forget('allow_entity_sensor.amperes');
        ...
        // test append
        $community = twentyfouronlineConfig::get('snmp.community');
        ...
        $this->assertEquals(['ethernet', 'psuedowire'], twentyfouronlineConfig::get('os.netonix.bad_iftype'));
        ...
        $this->artisan('config:get', ['--dump' => true])
            ->expectsOutput(twentyfouronlineConfig::toJson())
            ->assertExitCode(0);
    }
    ...
    public function testInvalidSetting(): void
    {
        ...
        // append to non-array
        twentyfouronlineConfig::set('login_message', 'blah');
        twentyfouronlineConfig::get('login_message');
    ...
    {
        $this->assertSame($expected, twentyfouronlineConfig::get($setting));
