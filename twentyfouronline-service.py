...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="twentyfouronline Service - manages polling and other periodic processes"
    )
    parser.add_argument(
        "-g",
        "--group",
    ...
    info("Configuring twentyfouronline service")
    try:
        service = twentyfouronline.Service()
    ...
    info(
        "Entering main twentyfouronline service loop on {}/{}...".format(
