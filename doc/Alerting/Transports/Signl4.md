...
Integrating SIGNL4 with twentyfouronline to forward critical alerts with detailed information to responsible people or on-call teams. The integration supports triggering as well as closing alerts.
...
You can find more information about the integration [here](https://docs.signl4.com/integrations/twentyfouronline/twentyfouronline.html).
