...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/services
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/services?state=2
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/services?state=0&type=tcp
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/services/:hostname
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/services/:hostname?state=2
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/services/:hostname?state=0&type=tcp
```
...
```curl
curl -X POST -d '{"type":"ping","ip": "192.168.1.10","desc":"test ping","param": "-t 10 -c 5"}' -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/services/192.168.1.10
```
...
```curl
curl -X PATCH -d '{"service_disabled":"1"}' 'X-Auth-Token:YOUR-API-TOKEN' https://twentyfouronline.org/api/v0/services/5
```
...
```curl
curl -X DELETE -H 'X-Auth-Token:YOUR-API-TOKEN' https://twentyfouronline.org/api/v0/services/35
```
