...
```curl
curl -X DELETE -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/discover
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/availability
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/outages
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/graphs
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/health
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/health/device_voltage
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/health/device_voltage/1
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/wireless
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/wireless/device_wireless_ccq
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/health/device_wireless_ccq/1
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/graphs/health/device_voltage
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/graphs/health/device_voltage/1
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/graphs/wireless/device_wireless_ccq
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/graphs/wireless/device_wireless_ccq/1
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/device_poller_perf
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/services/localhost/35/graphs/loss
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/ports
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/fdb
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/nac
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/ip
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/port_stack?valid_mappings
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/transceivers
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/components
```
...
```curl
curl -X POST -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/components/APITEST
```
...
```curl
curl -X PUT -d '{"4459": {"type": "APITEST","label": "This is a test label","status": 1,"ignore": 0,"disabled": 0,"error": "","TestField": "TestData"}}' -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/components
```
...
```curl
curl -X DELETE -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/components/4459
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/ports/eth0
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/ports/eth0/port_bits
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/resources/sensors
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices?order=hostname%20DESC&type=down
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices?type=mac&query=00000c9ff013
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/maintenance
```
...
curl -H 'X-Auth-Token: YOURAPITOKENHERE' \
  -X POST https://twentyfouronline.org/api/v0/devices/localhost/maintenance/ \
  --data-raw '
...
```curl
curl -X PATCH -d '{"field": "notes", "data": "This server should be kept online"}' -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost
```
...
```curl
curl -X PATCH -d '{"notes": "This port is in a scheduled maintenance with the provider."}' -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/port/5
```
...
```curl
curl -X PATCH -d '{"field": ["notes","purpose"], "data": ["This server should be kept online", "For serving web traffic"]}' -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost
```
...
```curl
curl -X PATCH  -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/rename/localhost2
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/localhost/groups
```
...
Example:
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/oxidized/config/search/vlan10
```
...
```json
{
    ...
    "nodes": [
        {
            "node": "asr9k.twentyfouronline.org",
            "full_name": "cisco\/ASR9K.twentyfouronline.org"
        },
        {
            "node": "ios.twentyfouronline.org",
            "full_name": "cisco\/ios.twentyfouronline.org"
        }
    ],
    "count": 2
}
...
Route: `api/v0/oxidized/config/:hostname`
  ...
  - hostname is the Hostname or IP of the device used when adding the device to twentyfouronline.
...
Example:
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/oxidized/config/router.corp.com
```
...
Example:
```curl
curl -X POST -d '{"parent_ids":"15,16,17"}' -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/1/parents
```
...
Example:
```curl
curl -X DELETE -d '{"parent_ids":"15,16,17"}' -H 'X-Auth-Token: YOURAPITOKENHERE' https://twentyfouronline.org/api/v0/devices/1/parents
```
...
```curl
curl -H 'X-Auth-Token: YOURAPITOKENHERE' 'http://twentyfouronline.org/api/v0/devices?type=device_id&query=34'
```
