...
* Fix APC current divide by zero ([#14578](https://github.com/twentyfouronline/twentyfouronline/pull/14578)) - [murrant](https://github.com/murrant)
...
* Sort alert transport by name ([#14464](https://github.com/twentyfouronline/twentyfouronline/pull/14464)) - [SourceDoctor](https://github.com/SourceDoctor)
...
* Add initselect2 to locations ports ([#14375](https://github.com/twentyfouronline/twentyfouronline/pull/14375)) - [KayckMatias](https://github.com/KayckMatias)
...
* Fix ARP Table on Device overview ([#14304](https://github.com/twentyfouronline/twentyfouronline/pull/14304)) - [Npeca75](https://github.com/Npeca75)
...
* Misc errors cleanup ([#14257](https://github.com/twentyfouronline/twentyfouronline/pull/14257)) - [Jellyfrog](https://github.com/Jellyfrog)
...
* Replace git show --no-patch option with --quiet ([#14160](https://github.com/twentyfouronline/twentyfouronline/pull/14160)) - [ciscoqid](https://github.com/ciscoqid)
...
* Bump guzzlehttp/guzzle from 7.4.3 to 7.4.4 ([#14025](https://github.com/twentyfouronline/twentyfouronline/pull/14025)) - [dependabot](https://github.com/apps/dependabot)
* Bump guzzlehttp/guzzle from 7.4.1 to 7.4.3 ([#13994](https://github.com/twentyfouronline/twentyfouronline/pull/13994)) - [dependabot](https://github.com/apps/dependabot)
...
#### Feature
* Allow unordered OIDs (global and per-os) ([#13923](https://github.com/twentyfouronline/twentyfouronline/pull/13923)) - [murrant](https://github.com/murrant)
* Added --ping-only to snmp-scan.py ([#13810](https://github.com/twentyfouronline/twentyfouronline/pull/13810)) - [IVI053](https://github.com/IVI053)

#### Device
* Add Cisco Business Wirless to ciscowlc.yaml ([#13984](https://github.com/twentyfouronline/twentyfouronline/pull/13984)) - [nsn-amagruder](https://github.com/nsn-amagruder)
* Add Eaton SC200 OS model ([#13978](https://github.com/twentyfouronline/twentyfouronline/pull/13978)) - [slimey99uk](https://github.com/slimey99uk)
* Fortigate LTE sensor addition ([#13977](https://github.com/twentyfouronline/twentyfouronline/pull/13977)) - [slimey99uk](https://github.com/slimey99uk)
* Added BKE power supply support. ([#13972](https://github.com/twentyfouronline/twentyfouronline/pull/13972)) - [Martin22](https://github.com/Martin22)
* Don't use bulk-walk for PrimeKey Appliances ([#13958](https://github.com/twentyfouronline/twentyfouronline/pull/13958)) - [bl3nd3r](https://github.com/bl3nd3r)
* Fix avtech12e sensors ([#13943](https://github.com/twentyfouronline/twentyfouronline/pull/13943)) - [lfkeitel](https://github.com/lfkeitel)
* [mikrotik] fixed RouterOS ipv4/ipv6 routes ([#13902](https://github.com/twentyfouronline/twentyfouronline/pull/13902)) - [Npeca75](https://github.com/Npeca75)
* Netscaler new counter metrics ([#13323](https://github.com/twentyfouronline/twentyfouronline/pull/13323)) - [mzacchi](https://github.com/mzacchi)

#### Webui
* Update dark mode to fix BGP and Peering page ([#13951](https://github.com/twentyfouronline/twentyfouronline/pull/13951)) - [Jimmy-Cl](https://github.com/Jimmy-Cl)
* Fix snmp.timeout setting via Web UI ([#13937](https://github.com/twentyfouronline/twentyfouronline/pull/13937)) - [murrant](https://github.com/murrant)

#### Alerting
* More realistic alert test data ([#13969](https://github.com/twentyfouronline/twentyfouronline/pull/13969)) - [murrant](https://github.com/murrant)

#### Graphs
* [RRD] fix IPv6 folder name ([#13945](https://github.com/twentyfouronline/twentyfouronline/pull/13945)) - [Npeca75](https://github.com/Npeca75)

#### Applications
* Remove alert keys from component for Suricata ([#13959](https://github.com/twentyfouronline/twentyfouronline/pull/13959)) - [VVelox](https://github.com/VVelox)
* Fix a few issues with variable names for Suricata ([#13956](https://github.com/twentyfouronline/twentyfouronline/pull/13956)) - [VVelox](https://github.com/VVelox)
* Scripts/json-app-tool.php JSON generation fix and add -S for SNMP extend name ([#13948](https://github.com/twentyfouronline/twentyfouronline/pull/13948)) - [VVelox](https://github.com/VVelox)
* Add Suricata monitoring ([#13942](https://github.com/twentyfouronline/twentyfouronline/pull/13942)) - [VVelox](https://github.com/VVelox)

#### Discovery
* Fix polling and discovery of FortiGate cluster sensors ([#13980](https://github.com/twentyfouronline/twentyfouronline/pull/13980)) - [mkuurstra](https://github.com/mkuurstra)

#### Oxidized
* Oxidized API to return groups based on device purpose or notes ([#13976](https://github.com/twentyfouronline/twentyfouronline/pull/13976)) - [sajiby3k](https://github.com/sajiby3k)

#### Authentication
* Auth_ldap_skip_group_check when ldap_compare is not supported ([#13926](https://github.com/twentyfouronline/twentyfouronline/pull/13926)) - [micko](https://github.com/micko)
* Add LDAP bind and userlist filter support to ldap-authorization ([#13788](https://github.com/twentyfouronline/twentyfouronline/pull/13788)) - [pfromme25](https://github.com/pfromme25)

#### Bug
* Inconsistency in ldap starttls config parameter ([#13987](https://github.com/twentyfouronline/twentyfouronline/pull/13987)) - [nox-x](https://github.com/nox-x)
* Fix version check error ([#13981](https://github.com/twentyfouronline/twentyfouronline/pull/13981)) - [murrant](https://github.com/murrant)
* Use full sudo path ([#13975](https://github.com/twentyfouronline/twentyfouronline/pull/13975)) - [skandragon](https://github.com/skandragon)
* Fix IPv6 in service check host ([#13939](https://github.com/twentyfouronline/twentyfouronline/pull/13939)) - [steffann](https://github.com/steffann)

#### Refactor
* Improve the efficiency of some queries ([#13974](https://github.com/twentyfouronline/twentyfouronline/pull/13974)) - [murrant](https://github.com/murrant)
* Move Config loading to a service provider ([#13927](https://github.com/twentyfouronline/twentyfouronline/pull/13927)) - [murrant](https://github.com/murrant)

#### Documentation
* Fix typo in dispatcher service doc ([#13979](https://github.com/twentyfouronline/twentyfouronline/pull/13979)) - [booth-f](https://github.com/booth-f)
* Fix  a typo in alerting doc ([#13970](https://github.com/twentyfouronline/twentyfouronline/pull/13970)) - [twelch24](https://github.com/twelch24)
* DOCS, switch to dark or light mode ([#13953](https://github.com/twentyfouronline/twentyfouronline/pull/13953)) - [SantiagoSilvaZ](https://github.com/SantiagoSilvaZ)
* Assorted cleanups to alerting docs, primarily to make mdl happier ([#13950](https://github.com/twentyfouronline/twentyfouronline/pull/13950)) - [VVelox](https://github.com/VVelox)
* Update test doc making it more mdl happy and add a section on writing JSON app tests ([#13949](https://github.com/twentyfouronline/twentyfouronline/pull/13949)) - [VVelox](https://github.com/VVelox)

#### Translation
* Small Italian lang update ([#13960](https://github.com/twentyfouronline/twentyfouronline/pull/13960)) - [ppasserini](https://github.com/ppasserini)

#### Misc
* Improve lnms shortcut validation ([#13982](https://github.com/twentyfouronline/twentyfouronline/pull/13982)) - [murrant](https://github.com/murrant)

#### Dependencies
* Bump async from 2.6.3 to 2.6.4 ([#13947](https://github.com/twentyfouronline/twentyfouronline/pull/13947)) - [dependabot](https://github.com/apps/dependabot)
* Bump composer/composer from 2.2.4 to 2.3.5 ([#13944](https://github.com/twentyfouronline/twentyfouronline/pull/13944)) - [dependabot](https://github.com/apps/dependabot)
...
#### Feature
* Add ISIS discovery and polling for iosxe devices ([#13880](https://github.com/twentyfouronline/twentyfouronline/pull/13880)) - [WillIrvine](https://github.com/WillIrvine)

#### Security
* Fix services command injection ([#13932](https://github.com/twentyfouronline/twentyfouronline/pull/13932)) - [murrant](https://github.com/murrant)
* Fix Graylog XSS ([#13931](https://github.com/twentyfouronline/twentyfouronline/pull/13931)) - [murrant](https://github.com/murrant)
* Bump minimist from 1.2.5 to 1.2.6 ([#13872](https://github.com/twentyfouronline/twentyfouronline/pull/13872)) - [dependabot](https://github.com/apps/dependabot)
* Fix SQL injection in get-host-dependencies ([#13868](https://github.com/twentyfouronline/twentyfouronline/pull/13868)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Device
* Support tplink routers ([#13922](https://github.com/twentyfouronline/twentyfouronline/pull/13922)) - [si458](https://github.com/si458)
* Fix Hytera error ([#13909](https://github.com/twentyfouronline/twentyfouronline/pull/13909)) - [murrant](https://github.com/murrant)
* PrimeKey Improvements ([#13901](https://github.com/twentyfouronline/twentyfouronline/pull/13901)) - [bl3nd3r](https://github.com/bl3nd3r)
* Enhancements for Zyxel OS ([#13897](https://github.com/twentyfouronline/twentyfouronline/pull/13897)) - [Jimmy-Cl](https://github.com/Jimmy-Cl)
* Added support for Dell PowerVault ME4024 ([#13883](https://github.com/twentyfouronline/twentyfouronline/pull/13883)) - [laf](https://github.com/laf)
* Add support for Riello NetMan 204 ([#13878](https://github.com/twentyfouronline/twentyfouronline/pull/13878)) - [lucalo72](https://github.com/lucalo72)
* Fix usw flex switch hardware detection ([#13877](https://github.com/twentyfouronline/twentyfouronline/pull/13877)) - [Fehler12](https://github.com/Fehler12)
* Added Polycom Lens SNMP support. ([#13876](https://github.com/twentyfouronline/twentyfouronline/pull/13876)) - [Fehler12](https://github.com/Fehler12)
* Fix for PFSense state table removals field ([#13863](https://github.com/twentyfouronline/twentyfouronline/pull/13863)) - [dandare100](https://github.com/dandare100)
* McAfee Proxy Sensor name update ([#13853](https://github.com/twentyfouronline/twentyfouronline/pull/13853)) - [PipoCanaja](https://github.com/PipoCanaja)
* Add support for PrimeKey Hardware Appliance ([#13806](https://github.com/twentyfouronline/twentyfouronline/pull/13806)) - [bl3nd3r](https://github.com/bl3nd3r)

#### Webui
* Add ISIS-details to alert details ([#13920](https://github.com/twentyfouronline/twentyfouronline/pull/13920)) - [ottorei](https://github.com/ottorei)
* Fix port mini graphs ([#13911](https://github.com/twentyfouronline/twentyfouronline/pull/13911)) - [murrant](https://github.com/murrant)
* Replaced OpenWRT icon with new logo ([#13891](https://github.com/twentyfouronline/twentyfouronline/pull/13891)) - [frenchie](https://github.com/frenchie)
* Add "Ping Response" graph to "Ping Only" Device Overview page ([#13886](https://github.com/twentyfouronline/twentyfouronline/pull/13886)) - [westerterp](https://github.com/westerterp)
* Remove fix size for column mac adresse ([#13881](https://github.com/twentyfouronline/twentyfouronline/pull/13881)) - [Cormoran96](https://github.com/Cormoran96)
* Fixed the top port errors widget returning bits graphs instead ([#13860](https://github.com/twentyfouronline/twentyfouronline/pull/13860)) - [laf](https://github.com/laf)

#### Alerting
* Correct type hint ([#13915](https://github.com/twentyfouronline/twentyfouronline/pull/13915)) - [TheMysteriousX](https://github.com/TheMysteriousX)
* Improve alert template saving ([#13910](https://github.com/twentyfouronline/twentyfouronline/pull/13910)) - [murrant](https://github.com/murrant)
* Added Basic authentication capability to Alertmanager Transport ([#13867](https://github.com/twentyfouronline/twentyfouronline/pull/13867)) - [geg347](https://github.com/geg347)

#### Snmp Traps
* Add Cisco Err-Disable interface event trap handler ([#13855](https://github.com/twentyfouronline/twentyfouronline/pull/13855)) - [bonzo81](https://github.com/bonzo81)

#### Api
* Ensure 'add_device' API returns indexed-array (as per doco) ([#13887](https://github.com/twentyfouronline/twentyfouronline/pull/13887)) - [claude191](https://github.com/claude191)

#### Polling
* Fix STP polling bug ([#13924](https://github.com/twentyfouronline/twentyfouronline/pull/13924)) - [murrant](https://github.com/murrant)
* Print full error message in poller/discovery output ([#13903](https://github.com/twentyfouronline/twentyfouronline/pull/13903)) - [murrant](https://github.com/murrant)

#### Rancid
* Add MRV OptiDriver support in gen_rancid ([#13900](https://github.com/twentyfouronline/twentyfouronline/pull/13900)) - [cliffalbert](https://github.com/cliffalbert)
* Add support for VyOS on Rancid conf ([#13874](https://github.com/twentyfouronline/twentyfouronline/pull/13874)) - [ssasso](https://github.com/ssasso)

#### Bug
* Validate fixes ([#13935](https://github.com/twentyfouronline/twentyfouronline/pull/13935)) - [murrant](https://github.com/murrant)
* Lnms device:add handle snmp.community bad format ([#13914](https://github.com/twentyfouronline/twentyfouronline/pull/13914)) - [murrant](https://github.com/murrant)
* Fix install icons ([#13904](https://github.com/twentyfouronline/twentyfouronline/pull/13904)) - [murrant](https://github.com/murrant)
* Handle bad uptime input ([#13899](https://github.com/twentyfouronline/twentyfouronline/pull/13899)) - [murrant](https://github.com/murrant)
* Fix custom error messages ([#13898](https://github.com/twentyfouronline/twentyfouronline/pull/13898)) - [murrant](https://github.com/murrant)
* Migrate addhost.php to lnms device:add ([#13870](https://github.com/twentyfouronline/twentyfouronline/pull/13870)) - [murrant](https://github.com/murrant)

#### Refactor
* Port Validation Page to Laravel ([#13921](https://github.com/twentyfouronline/twentyfouronline/pull/13921)) - [murrant](https://github.com/murrant)

#### Cleanup
* Better device:add error output ([#13913](https://github.com/twentyfouronline/twentyfouronline/pull/13913)) - [murrant](https://github.com/murrant)
* Remove non-working Dell specific alert rules from the collection ([#13706](https://github.com/twentyfouronline/twentyfouronline/pull/13706)) - [Fehler12](https://github.com/Fehler12)

#### Documentation
* Docs, fix code block in oxidized group ([#13908](https://github.com/twentyfouronline/twentyfouronline/pull/13908)) - [SantiagoSilvaZ](https://github.com/SantiagoSilvaZ)
* [DOC] Fix Code blocks Step 2 Installing Network-WeatherMap ([#13905](https://github.com/twentyfouronline/twentyfouronline/pull/13905)) - [SantiagoSilvaZ](https://github.com/SantiagoSilvaZ)
* [DOC] Styling the .env word quote ([#13889](https://github.com/twentyfouronline/twentyfouronline/pull/13889)) - [SantiagoSilvaZ](https://github.com/SantiagoSilvaZ)
* Docs, fix Linux SNMP example only listening on ::1 ([#13882](https://github.com/twentyfouronline/twentyfouronline/pull/13882)) - [murrant](https://github.com/murrant)
* Script that describes how to migrate traffic bills from observium. ([#13757](https://github.com/twentyfouronline/twentyfouronline/pull/13757)) - [manonfgoo](https://github.com/manonfgoo)

#### Translation
* Ukrainian translation update ([#13933](https://github.com/twentyfouronline/twentyfouronline/pull/13933)) - [p4k8](https://github.com/p4k8)
* Few more language (ITA) updates ([#13890](https://github.com/twentyfouronline/twentyfouronline/pull/13890)) - [ppasserini](https://github.com/ppasserini)

#### Dependencies
* Bump guzzlehttp/psr7 from 2.1.0 to 2.2.1 ([#13879](https://github.com/twentyfouronline/twentyfouronline/pull/13879)) - [dependabot](https://github.com/apps/dependabot)
* Bump jpgraph version to 4 ([#13875](https://github.com/twentyfouronline/twentyfouronline/pull/13875)) - [ottorei](https://github.com/ottorei)
* Bump node-forge from 1.2.1 to 1.3.0 ([#13869](https://github.com/twentyfouronline/twentyfouronline/pull/13869)) - [dependabot](https://github.com/apps/dependabot)
...
#### Feature
* Device_add support display field ([#13846](https://github.com/twentyfouronline/twentyfouronline/pull/13846)) - [murrant](https://github.com/murrant)
* Display Name in availability map ([#13841](https://github.com/twentyfouronline/twentyfouronline/pull/13841)) - [murrant](https://github.com/murrant)
* Implement OAuth and SAML2 support ([#13764](https://github.com/twentyfouronline/twentyfouronline/pull/13764)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Security
* Resolved XSS issue from alert rule list modal ([#13805](https://github.com/twentyfouronline/twentyfouronline/pull/13805)) - [laf](https://github.com/laf)

#### Device
* Add support for VOSS 8.6 ([#13857](https://github.com/twentyfouronline/twentyfouronline/pull/13857)) - [ospfbgp](https://github.com/ospfbgp)
* Device - HWG-WLD version 2 support ([#13849](https://github.com/twentyfouronline/twentyfouronline/pull/13849)) - [PipoCanaja](https://github.com/PipoCanaja)
* Fix an issue with the APC current discovery ([#13837](https://github.com/twentyfouronline/twentyfouronline/pull/13837)) - [eskyuu](https://github.com/eskyuu)
* Add VS state for Gaia ([#13831](https://github.com/twentyfouronline/twentyfouronline/pull/13831)) - [martinberg](https://github.com/martinberg)
* [new OS] Alpine OptoElectronics TDCM-EDFA support ([#13825](https://github.com/twentyfouronline/twentyfouronline/pull/13825)) - [charlyforot](https://github.com/charlyforot)
* Fix db delete on cisco-vrf-lite discovery ([#13823](https://github.com/twentyfouronline/twentyfouronline/pull/13823)) - [lpailhas](https://github.com/lpailhas)
* Add rocky linux OS identification ([#13815](https://github.com/twentyfouronline/twentyfouronline/pull/13815)) - [hanserasmus](https://github.com/hanserasmus)
* Detect truenas scale ([#13812](https://github.com/twentyfouronline/twentyfouronline/pull/13812)) - [si458](https://github.com/si458)
* [comware] dropped dbfetch from discovery/sensors ([#13796](https://github.com/twentyfouronline/twentyfouronline/pull/13796)) - [Npeca75](https://github.com/Npeca75)
* Correct divisor in discovery definition vertiv-pdu.yaml ([#13768](https://github.com/twentyfouronline/twentyfouronline/pull/13768)) - [woidi](https://github.com/woidi)

#### Webui
* Fixed displaying hostname in create bill when port is passed ([#13830](https://github.com/twentyfouronline/twentyfouronline/pull/13830)) - [laf](https://github.com/laf)
* Fix Oxidized Config tab showing when Device OS or Device Type is disabled ([#13809](https://github.com/twentyfouronline/twentyfouronline/pull/13809)) - [westerterp](https://github.com/westerterp)
* Position the buttons in the center on user preferences page ([#13802](https://github.com/twentyfouronline/twentyfouronline/pull/13802)) - [SantiagoSilvaZ](https://github.com/SantiagoSilvaZ)
* Add usage hints for Display Name placeholder usage ([#13801](https://github.com/twentyfouronline/twentyfouronline/pull/13801)) - [LTangaF](https://github.com/LTangaF)
* Fix second menu bar in Apps screens ([#13800](https://github.com/twentyfouronline/twentyfouronline/pull/13800)) - [westerterp](https://github.com/westerterp)
* WebUI - Search results for ports ([#13787](https://github.com/twentyfouronline/twentyfouronline/pull/13787)) - [PipoCanaja](https://github.com/PipoCanaja)

#### Alerting
* Newer versions of Jira use HTTP code 201 fore created issues ([#13852](https://github.com/twentyfouronline/twentyfouronline/pull/13852)) - [MrXermon](https://github.com/MrXermon)
* Add extra dynamic values alerttransport alertmanager ([#13828](https://github.com/twentyfouronline/twentyfouronline/pull/13828)) - [geg347](https://github.com/geg347)

#### Snmp Traps
* Add APC SmartAvrReducing trap handlers ([#13839](https://github.com/twentyfouronline/twentyfouronline/pull/13839)) - [bonzo81](https://github.com/bonzo81)
* Add APC upsOnBattery & powerRestored trap handler ([#13836](https://github.com/twentyfouronline/twentyfouronline/pull/13836)) - [bonzo81](https://github.com/bonzo81)
* Add OspfTxRetransmit Trap Handler ([#13824](https://github.com/twentyfouronline/twentyfouronline/pull/13824)) - [bonzo81](https://github.com/bonzo81)
* Cisco Mac address violation trap handler ([#13811](https://github.com/twentyfouronline/twentyfouronline/pull/13811)) - [bonzo81](https://github.com/bonzo81)

#### Api
* Adds API call to update port notes on devices. ([#13834](https://github.com/twentyfouronline/twentyfouronline/pull/13834)) - [josh-silvas](https://github.com/josh-silvas)

#### Bug
* Rewrite agent packages parsing code ([#13840](https://github.com/twentyfouronline/twentyfouronline/pull/13840)) - [murrant](https://github.com/murrant)
* Fix snmpv3 context when empty SnmpQuery ([#13832](https://github.com/twentyfouronline/twentyfouronline/pull/13832)) - [murrant](https://github.com/murrant)
* Regression fix from b6a8b602b891d9eb8633f62632c17bdc559cd620 ([#13819](https://github.com/twentyfouronline/twentyfouronline/pull/13819)) - [Jellyfrog](https://github.com/Jellyfrog)
* Fix PHPStan Deprecated test ([#13794](https://github.com/twentyfouronline/twentyfouronline/pull/13794)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Refactor
* Remove addHost from ModuleTestHelper ([#13847](https://github.com/twentyfouronline/twentyfouronline/pull/13847)) - [murrant](https://github.com/murrant)

#### Tests
* PHP8 phpstan fix ([#13843](https://github.com/twentyfouronline/twentyfouronline/pull/13843)) - [murrant](https://github.com/murrant)
* Fix tests for MariaDB \> 10.5.15 ([#13829](https://github.com/twentyfouronline/twentyfouronline/pull/13829)) - [Jellyfrog](https://github.com/Jellyfrog)
* Add MIB to OS helper to tests ([#13795](https://github.com/twentyfouronline/twentyfouronline/pull/13795)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Misc
* Add configuration support for IPMIv2 Kg key ([#13845](https://github.com/twentyfouronline/twentyfouronline/pull/13845)) - [pandalion98](https://github.com/pandalion98)
* New device:add code ([#13842](https://github.com/twentyfouronline/twentyfouronline/pull/13842)) - [murrant](https://github.com/murrant)
* Fix class error name prevents to show BER graph ([#13833](https://github.com/twentyfouronline/twentyfouronline/pull/13833)) - [charlyforot](https://github.com/charlyforot)
* Add generic PSU status failed alert rule template ([#13821](https://github.com/twentyfouronline/twentyfouronline/pull/13821)) - [geg347](https://github.com/geg347)
* Bump version to 22.2.1 ([#13798](https://github.com/twentyfouronline/twentyfouronline/pull/13798)) - [dlangille](https://github.com/dlangille)
...
#### Feature
* Implement system for user packages in composer ([#13718](https://github.com/twentyfouronline/twentyfouronline/pull/13718)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Security
* Hide community and make it XSS safer ([#13783](https://github.com/twentyfouronline/twentyfouronline/pull/13783)) - [PipoCanaja](https://github.com/PipoCanaja)
* Moved some pages to be within admin route ([#13782](https://github.com/twentyfouronline/twentyfouronline/pull/13782)) - [laf](https://github.com/laf)
* XSS fix ([#13780](https://github.com/twentyfouronline/twentyfouronline/pull/13780)),([#13778](https://github.com/twentyfouronline/twentyfouronline/pull/13778)),([#13776](https://github.com/twentyfouronline/twentyfouronline/pull/13776)),([#13775](https://github.com/twentyfouronline/twentyfouronline/pull/13775)) - [PipoCanaja](https://github.com/PipoCanaja)
* Bump follow-redirects package from 1.14.7 to 1.14.8 ([#13774](https://github.com/twentyfouronline/twentyfouronline/pull/13774)) - [dependabot](https://github.com/apps/dependabot)

#### Device
* Support for Terra sdi410c / sdi480 devices ([#13759](https://github.com/twentyfouronline/twentyfouronline/pull/13759)) - [Npeca75](https://github.com/Npeca75)
* Added BER to Racom Ray and Ray3 ([#13758](https://github.com/twentyfouronline/twentyfouronline/pull/13758)) - [Martin22](https://github.com/Martin22)
* Added system temperature support including state for Extreme VSP 4900 devices ([#13743](https://github.com/twentyfouronline/twentyfouronline/pull/13743)) - [laf](https://github.com/laf)
* Added ipv6 route discovery for Mikrotik devices ([#13737](https://github.com/twentyfouronline/twentyfouronline/pull/13737)) - [Npeca75](https://github.com/Npeca75)
* Fixed airos temp in 8.7.7 for ubnt devices ([#13731](https://github.com/twentyfouronline/twentyfouronline/pull/13731)) - [murrant](https://github.com/murrant)
* Added sensors to ZXA OS ([#13724](https://github.com/twentyfouronline/twentyfouronline/pull/13724)) - [aztec102](https://github.com/aztec102)
* Added support for Volius OS ([#13723](https://github.com/twentyfouronline/twentyfouronline/pull/13723)) - [aztec102](https://github.com/aztec102)
* Updated DDM MIBs for Jetstream OS ([#13715](https://github.com/twentyfouronline/twentyfouronline/pull/13715)) - [Npeca75](https://github.com/Npeca75)
* Added support for Ubiquiti Airfiber60 devices ([#13680](https://github.com/twentyfouronline/twentyfouronline/pull/13680)) - [jepke](https://github.com/jepke)
* Fixed Temperature Sensor for AirOS 8.7.4+ ([#13655](https://github.com/twentyfouronline/twentyfouronline/pull/13655)) - [JKJameson](https://github.com/JKJameson)
* Added support for Lenovo think station devices ([#13617](https://github.com/twentyfouronline/twentyfouronline/pull/13617)) - [Fehler12](https://github.com/Fehler12)
* Added sensors for huawei vrp devices ([#13352](https://github.com/twentyfouronline/twentyfouronline/pull/13352)) - [guipoletto](https://github.com/guipoletto)

#### Webui
* Rewrite includes/html/pages/device/health.inc.php ([#13777](https://github.com/twentyfouronline/twentyfouronline/pull/13777)) - [Npeca75](https://github.com/Npeca75)
* Various fixes for STP ([#13773](https://github.com/twentyfouronline/twentyfouronline/pull/13773)) - [PipoCanaja](https://github.com/PipoCanaja)
* Added missing icons for progressive web app ([#13771](https://github.com/twentyfouronline/twentyfouronline/pull/13771)) - [murrant](https://github.com/murrant)
* Show selected selection option on graphs page in Mono theme ([#13765](https://github.com/twentyfouronline/twentyfouronline/pull/13765)) - [SantiagoSilvaZ](https://github.com/SantiagoSilvaZ)
* Show selected option of devices-graphs-select in Mono theme ([#13752](https://github.com/twentyfouronline/twentyfouronline/pull/13752)) - [SantiagoSilvaZ](https://github.com/SantiagoSilvaZ)
* Upgrade to font awesome 6 ([#13760](https://github.com/twentyfouronline/twentyfouronline/pull/13760)) - [Jellyfrog](https://github.com/Jellyfrog)
* Upgrade to font awesome 5 ([#13754](https://github.com/twentyfouronline/twentyfouronline/pull/13754)) - [Jellyfrog](https://github.com/Jellyfrog)
* Update dark.css to improve visibility ([#13749](https://github.com/twentyfouronline/twentyfouronline/pull/13749)) - [dfitton](https://github.com/dfitton)
* Removing colon symbol from multiple dialogs ([#13742](https://github.com/twentyfouronline/twentyfouronline/pull/13742)) - [ilGino](https://github.com/ilGino)
* Added the word Actions in the header of the oxidized-nodes table ([#13741](https://github.com/twentyfouronline/twentyfouronline/pull/13741)) - [SantiagoSilvaZ](https://github.com/SantiagoSilvaZ)
* Updated icons of links pointing to Health pages ([#13729](https://github.com/twentyfouronline/twentyfouronline/pull/13729)) - [ilGino](https://github.com/ilGino)
* Updated to a more consistent Fontawesome icon for the Export to PDF ([#13713](https://github.com/twentyfouronline/twentyfouronline/pull/13713)) - [ilGino](https://github.com/ilGino)
* Removing the colon symbol to the right of a control labels ([#13704](https://github.com/twentyfouronline/twentyfouronline/pull/13704)),([#13705](https://github.com/twentyfouronline/twentyfouronline/pull/13705)) - [ilGino](https://github.com/ilGino)
* Update to tailwind 3 ([#13695](https://github.com/twentyfouronline/twentyfouronline/pull/13695)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Alerting
* Added better default sensor alert template ([#13703](https://github.com/twentyfouronline/twentyfouronline/pull/13703)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Snmp Traps
* Added SNMP Traps for Brocade login traps ([#13770](https://github.com/twentyfouronline/twentyfouronline/pull/13770)) - [h-barnhart](https://github.com/h-barnhart)
* Added SNMP Traps for APC Overload Traps ([#13726](https://github.com/twentyfouronline/twentyfouronline/pull/13726)) - [h-barnhart](https://github.com/h-barnhart)

#### Discovery
* Check for empty SLA tags so we skip bad entries ([#13679](https://github.com/twentyfouronline/twentyfouronline/pull/13679)) - [laf](https://github.com/laf)

#### Bug
* Only try contexts in STP for Cisco devices ([#13767](https://github.com/twentyfouronline/twentyfouronline/pull/13767)) - [murrant](https://github.com/murrant)
* Fix settings array initial value ([#13755](https://github.com/twentyfouronline/twentyfouronline/pull/13755)) - [Jellyfrog](https://github.com/Jellyfrog)
* Use better filesystem functions to delete host rrd dir ([#13735](https://github.com/twentyfouronline/twentyfouronline/pull/13735)) - [Jellyfrog](https://github.com/Jellyfrog)
* Device:poll log poll complete ([#13733](https://github.com/twentyfouronline/twentyfouronline/pull/13733)) - [murrant](https://github.com/murrant)
* Fixed \< 0 exception in ports poller ([#13732](https://github.com/twentyfouronline/twentyfouronline/pull/13732)) - [murrant](https://github.com/murrant)
* Fixed ups-nut check ([#13722](https://github.com/twentyfouronline/twentyfouronline/pull/13722)) - [Jellyfrog](https://github.com/Jellyfrog)
* Changed fping hardcoded binary to user defined fping ([#13720](https://github.com/twentyfouronline/twentyfouronline/pull/13720)) - [sGoico](https://github.com/sGoico)

#### Refactor
* Oxidized reload called on Device update and remove ([#13730](https://github.com/twentyfouronline/twentyfouronline/pull/13730)) - [murrant](https://github.com/murrant)
* Stp module rewrite ([#13570](https://github.com/twentyfouronline/twentyfouronline/pull/13570)) - [murrant](https://github.com/murrant)

#### Cleanup
* Dropped dbfetch from discovery/sensors for pbn devices ([#13789](https://github.com/twentyfouronline/twentyfouronline/pull/13789)) - [Npeca75](https://github.com/Npeca75)
* Dropped dbfetch from discovery/sensors for junos devices ([#13784](https://github.com/twentyfouronline/twentyfouronline/pull/13784)) - [Npeca75](https://github.com/Npeca75)
* Removed contrib directory ([#13727](https://github.com/twentyfouronline/twentyfouronline/pull/13727)) - [murrant](https://github.com/murrant)
* Removed old vendor fix ([#13717](https://github.com/twentyfouronline/twentyfouronline/pull/13717)) - [Jellyfrog](https://github.com/Jellyfrog)
* Replace Requests library with HTTP Client ([#13689](https://github.com/twentyfouronline/twentyfouronline/pull/13689)) - [Jellyfrog](https://github.com/Jellyfrog)
* Use built in method to render a string with Blade ([#13688](https://github.com/twentyfouronline/twentyfouronline/pull/13688)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Documentation
* Simple docs tweaking ([#13792](https://github.com/twentyfouronline/twentyfouronline/pull/13792)) - [Jellyfrog](https://github.com/Jellyfrog)
* Update Switching API doc to fix link ([#13786](https://github.com/twentyfouronline/twentyfouronline/pull/13786)) - [knpo](https://github.com/knpo)
* Rename DHCP Stats to ISC DHCP Stats ([#13756](https://github.com/twentyfouronline/twentyfouronline/pull/13756)) - [SourceDoctor](https://github.com/SourceDoctor)
* Update Install-twentyfouronline.md to include pip3 install ([#13746](https://github.com/twentyfouronline/twentyfouronline/pull/13746)) - [si458](https://github.com/si458)
* validate-config-icon better positioning in the text ([#13744](https://github.com/twentyfouronline/twentyfouronline/pull/13744)) - [SantiagoSilvaZ](https://github.com/SantiagoSilvaZ)
* Updated Debian install docs to include pip3 install ([#13721](https://github.com/twentyfouronline/twentyfouronline/pull/13721)) - [dorkmatt](https://github.com/dorkmatt)
* Full rework of documentation for better nav, cleanup and fixes ([#13709](https://github.com/twentyfouronline/twentyfouronline/pull/13709)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Tests
* Bump test timeout to 2 hours ([#13769](https://github.com/twentyfouronline/twentyfouronline/pull/13769)) - [Jellyfrog](https://github.com/Jellyfrog)
* Speed up tests by reducing snmp timeout ([#13725](https://github.com/twentyfouronline/twentyfouronline/pull/13725)) - [murrant](https://github.com/murrant)
* Lnms dev:check add --os-modules-only option ([#13700](https://github.com/twentyfouronline/twentyfouronline/pull/13700)) - [murrant](https://github.com/murrant)

#### Misc
* Set default DB_TEST_PORT in database config ([#13793](https://github.com/twentyfouronline/twentyfouronline/pull/13793)) - [Jellyfrog](https://github.com/Jellyfrog)
* Fixed links to connected devices in old style maps ([#13762](https://github.com/twentyfouronline/twentyfouronline/pull/13762)) - [fsmeets](https://github.com/fsmeets)
* Updated Top Devices widget to include filtering on ifOperStatus ([#13748](https://github.com/twentyfouronline/twentyfouronline/pull/13748)) - [Npeca75](https://github.com/Npeca75)
* Correct prefix for "kilo" should be small k, not capital K ([#13714](https://github.com/twentyfouronline/twentyfouronline/pull/13714)) - [ilGino](https://github.com/ilGino)
* Remove old composer preinstall script ([#13712](https://github.com/twentyfouronline/twentyfouronline/pull/13712)) - [Jellyfrog](https://github.com/Jellyfrog)
* Improve Proxy::shouldBeUsed ([#13702](https://github.com/twentyfouronline/twentyfouronline/pull/13702)) - [Jellyfrog](https://github.com/Jellyfrog)
* Use commit date to compare pull requestes ([#13701](https://github.com/twentyfouronline/twentyfouronline/pull/13701)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Dependencies
* Update JS deps ([#13694](https://github.com/twentyfouronline/twentyfouronline/pull/13694)) - [Jellyfrog](https://github.com/Jellyfrog)
* Update dependencies ([#13684](https://github.com/twentyfouronline/twentyfouronline/pull/13684)) - [Jellyfrog](https://github.com/Jellyfrog)
...
#### Feature
* Add Sla jitter packet loss percent graph ([#13600](https://github.com/twentyfouronline/twentyfouronline/pull/13600)) - [bonzo81](https://github.com/bonzo81)
* Add API-routes for listing MPLS SAPs and services ([#13561](https://github.com/twentyfouronline/twentyfouronline/pull/13561)) - [blubecks](https://github.com/blubecks)

#### Device
* Merge enviromux-micro in existing NTI ([#13696](https://github.com/twentyfouronline/twentyfouronline/pull/13696)) - [Npeca75](https://github.com/Npeca75)
* Change the variable to detect version for mikrotik ups runtime device divisor ([#13678](https://github.com/twentyfouronline/twentyfouronline/pull/13678)) - [TechieDylan](https://github.com/TechieDylan)
* VRP BGP fixes ([#13675](https://github.com/twentyfouronline/twentyfouronline/pull/13675)) - [murrant](https://github.com/murrant)
* Added new sensors to mes23xx ([#13671](https://github.com/twentyfouronline/twentyfouronline/pull/13671)) - [Npeca75](https://github.com/Npeca75)
* Added initial detection MES2324F or MES2324FB ([#13669](https://github.com/twentyfouronline/twentyfouronline/pull/13669)) - [aztec102](https://github.com/aztec102)
* New OS: Adva XG 304 ([#13668](https://github.com/twentyfouronline/twentyfouronline/pull/13668)) - [h-barnhart](https://github.com/h-barnhart)
* Basic ZTE ZXA10 detection ([#13658](https://github.com/twentyfouronline/twentyfouronline/pull/13658)) - [murrant](https://github.com/murrant)
* Added CET Power T2S TSI ([#13645](https://github.com/twentyfouronline/twentyfouronline/pull/13645)) - [aztec102](https://github.com/aztec102)
* Eltek ospf poller disable ([#13635](https://github.com/twentyfouronline/twentyfouronline/pull/13635)) - [loopodoopo](https://github.com/loopodoopo)
* Smartoptics dcp m 40 zr ([#13634](https://github.com/twentyfouronline/twentyfouronline/pull/13634)) - [avermeer-tc](https://github.com/avermeer-tc)
* Updated XOS (Extreme) processor data to use correct OID ([#13633](https://github.com/twentyfouronline/twentyfouronline/pull/13633)) - [laf](https://github.com/laf)
* Initial Support for Fujitsu RX300 with iRMC4 ([#13631](https://github.com/twentyfouronline/twentyfouronline/pull/13631)) - [Fehler12](https://github.com/Fehler12)
* Teleste Luminato ports & qam/asi output sensors & yaml ([#13616](https://github.com/twentyfouronline/twentyfouronline/pull/13616)) - [Npeca75](https://github.com/Npeca75)
* Workaround linksys always mapping to g1 ([#13595](https://github.com/twentyfouronline/twentyfouronline/pull/13595)) - [glance-](https://github.com/glance-)
* Equallogic fix typo on os name in the storage module ([#13580](https://github.com/twentyfouronline/twentyfouronline/pull/13580)) - [iopsthecloud](https://github.com/iopsthecloud)

#### Webui
* [WebUI] Removing the colon symbol to the right of a control label ([#13698](https://github.com/twentyfouronline/twentyfouronline/pull/13698)) - [ilGino](https://github.com/ilGino)
* Remove unneccessary Section Description ([#13677](https://github.com/twentyfouronline/twentyfouronline/pull/13677)) - [SourceDoctor](https://github.com/SourceDoctor)
* Device tracepath using wrong variables to check for traceroute output ([#13674](https://github.com/twentyfouronline/twentyfouronline/pull/13674)) - [laf](https://github.com/laf)
* Allow filter by display name in device list ([#13665](https://github.com/twentyfouronline/twentyfouronline/pull/13665)) - [gdepeyrot](https://github.com/gdepeyrot)
* Sort Vlan Ports by ifName, ifDescr ([#13657](https://github.com/twentyfouronline/twentyfouronline/pull/13657)) - [SourceDoctor](https://github.com/SourceDoctor)
* Fix horizontal scrollbar in device list always visible ([#13653](https://github.com/twentyfouronline/twentyfouronline/pull/13653)) - [efelon](https://github.com/efelon)

#### Alerting
* Use display name in alerts ([#13650](https://github.com/twentyfouronline/twentyfouronline/pull/13650)) - [murrant](https://github.com/murrant)

#### Graphs
* Timos sap dot1q graphing fix ([#13654](https://github.com/twentyfouronline/twentyfouronline/pull/13654)) - [loopodoopo](https://github.com/loopodoopo)

#### Applications
* Add supervisord application ([#13673](https://github.com/twentyfouronline/twentyfouronline/pull/13673)) - [hvanoch](https://github.com/hvanoch)

#### Api
* API detect if new location should be fixed by default ([#13637](https://github.com/twentyfouronline/twentyfouronline/pull/13637)) - [murrant](https://github.com/murrant)
* Set fixed_coordinates via api ([#13593](https://github.com/twentyfouronline/twentyfouronline/pull/13593)) - [VirTechSystems](https://github.com/VirTechSystems)

#### Polling
* Added oids.no_bulk os setting ([#13666](https://github.com/twentyfouronline/twentyfouronline/pull/13666)) - [Npeca75](https://github.com/Npeca75)
* Add consistent output of name and app_id to Poller for all Applications (fixes #13641) ([#13648](https://github.com/twentyfouronline/twentyfouronline/pull/13648)) - [westerterp](https://github.com/westerterp)
* Fix SnmpQuery bulk boolean backwards ([#13636](https://github.com/twentyfouronline/twentyfouronline/pull/13636)) - [murrant](https://github.com/murrant)

#### Rancid
* Gen RANCID host also for FS.com devices ([#13682](https://github.com/twentyfouronline/twentyfouronline/pull/13682)) - [ssasso](https://github.com/ssasso)

#### Bug
* Use PHP_BINARY directly instead of trying to build path to PHP binary ([#13690](https://github.com/twentyfouronline/twentyfouronline/pull/13690)) - [Jellyfrog](https://github.com/Jellyfrog)
* Small text change for misspelled Virtual ([#13686](https://github.com/twentyfouronline/twentyfouronline/pull/13686)) - [ilGino](https://github.com/ilGino)
* Snmp timeout is a float, allow in config ([#13676](https://github.com/twentyfouronline/twentyfouronline/pull/13676)) - [murrant](https://github.com/murrant)
* Fix NULL device alert caused by services ([#13663](https://github.com/twentyfouronline/twentyfouronline/pull/13663)) - [k0079898](https://github.com/k0079898)
* Disable VRP VLANs test, seems to be a bug in snmpsim snmpbulkwalk ([#13649](https://github.com/twentyfouronline/twentyfouronline/pull/13649)) - [murrant](https://github.com/murrant)
* Remove extra rows with duplicate keys in SyncsModels trait ([#13632](https://github.com/twentyfouronline/twentyfouronline/pull/13632)) - [murrant](https://github.com/murrant)

#### Documentation
* Update rrdcached link ([#13692](https://github.com/twentyfouronline/twentyfouronline/pull/13692)) - [twelch24](https://github.com/twelch24)
* Add missing python3-pip installation dependency for debian11 ([#13691](https://github.com/twentyfouronline/twentyfouronline/pull/13691)) - [tkjaer](https://github.com/tkjaer)

#### Translation
* Fix settings language file to include Distributed Poller labels. ([#13511](https://github.com/twentyfouronline/twentyfouronline/pull/13511)) - [thford89](https://github.com/thford89)

#### Dependencies
* Update recommended PHP version to 8.0 ([#13687](https://github.com/twentyfouronline/twentyfouronline/pull/13687)) - [Jellyfrog](https://github.com/Jellyfrog)
