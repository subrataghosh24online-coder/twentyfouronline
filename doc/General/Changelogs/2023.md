...
* Fix Fortinet HA-status polling state translations ([#14921](https://github.com/twentyfouronline/twentyfouronline/pull/14921)) - [ottorei](https://github.com/ottorei)
...
* Adding Active Power in Watts to APCs ([#15337](https://github.com/twentyfouronline/twentyfouronline/pull/15337)) - [Jimmy-Cl](https://github.com/Jimmy-Cl)
...
* Fix Device ip address mutator ([#15480](https://github.com/twentyfouronline/twentyfouronline/pull/15480)) - [murrant](https://github.com/murrant)
...
#### Feature
* Indicator on Port Notes tab when Port has notes ([#14923](https://github.com/twentyfouronline/twentyfouronline/pull/14923)) - [electrocret](https://github.com/electrocret)
* Syslog sink over http for logstash (or any json source) ([#14424](https://github.com/twentyfouronline/twentyfouronline/pull/14424)) - [Bierchermuesli](https://github.com/Bierchermuesli)

#### Device
* Update hikvision camera detection ([#14943](https://github.com/twentyfouronline/twentyfouronline/pull/14943)) - [torbeckattsp](https://github.com/torbeckattsp)
* APC UPS UIO sensor discovery bug ([#14942](https://github.com/twentyfouronline/twentyfouronline/pull/14942)) - [d-k-7](https://github.com/d-k-7)
* Add additional MOS / 7130 devices ([#14922](https://github.com/twentyfouronline/twentyfouronline/pull/14922)) - [kirk444](https://github.com/kirk444)
* Add support for WTI console products ([#14920](https://github.com/twentyfouronline/twentyfouronline/pull/14920)) - [robje](https://github.com/robje)
* Update junos discovery yaml to reference total memory instead of buff… ([#14919](https://github.com/twentyfouronline/twentyfouronline/pull/14919)) - [GeantRA](https://github.com/GeantRA)
* Add support for Trellix FireEye OS ([#14908](https://github.com/twentyfouronline/twentyfouronline/pull/14908)) - [mtentilucci](https://github.com/mtentilucci)
* Added cisco FTD 1150 to ftd.yaml ([#14907](https://github.com/twentyfouronline/twentyfouronline/pull/14907)) - [pjroehl](https://github.com/pjroehl)
* Add more OIDs for determining hardware and serial attributes correctly ([#14904](https://github.com/twentyfouronline/twentyfouronline/pull/14904)) - [mwobst](https://github.com/mwobst)
* Add Cisco FTD Support for security appliances (x3) ([#14893](https://github.com/twentyfouronline/twentyfouronline/pull/14893)) - [mwobst](https://github.com/mwobst)
* Update test data to account for new vertiv.svg icon ([#14892](https://github.com/twentyfouronline/twentyfouronline/pull/14892)) - [mtentilucci](https://github.com/mtentilucci)
* Improve Corero CMS support ([#14876](https://github.com/twentyfouronline/twentyfouronline/pull/14876)) - [electrocret](https://github.com/electrocret)
* Add Avocent MergePoint Unity KVM Switch Support ([#14874](https://github.com/twentyfouronline/twentyfouronline/pull/14874)) - [mtentilucci](https://github.com/mtentilucci)
* Add Fortigate Webfilter stats ([#14873](https://github.com/twentyfouronline/twentyfouronline/pull/14873)) - [electrocret](https://github.com/electrocret)
* Add Cisco Firepower 4112 Support ([#14872](https://github.com/twentyfouronline/twentyfouronline/pull/14872)) - [lukeofthetauri](https://github.com/lukeofthetauri)
* Added PoE controller load and status sensors for Junos devices ([#14868](https://github.com/twentyfouronline/twentyfouronline/pull/14868)) - [bakerds](https://github.com/bakerds)
* Add Montclair EDFA Support ([#14852](https://github.com/twentyfouronline/twentyfouronline/pull/14852)) - [peelman](https://github.com/peelman)
* Device - Add support for Scalance SC646-2C ([#14835](https://github.com/twentyfouronline/twentyfouronline/pull/14835)) - [jellejans](https://github.com/jellejans)
* Add Fortigate packet loss monitoring for Link-Monitor and SD-WAN ([#14828](https://github.com/twentyfouronline/twentyfouronline/pull/14828)) - [not-known](https://github.com/not-known)
* Refactored Juniper SLA to include support for TWAMP and remove ambigu… ([#14787](https://github.com/twentyfouronline/twentyfouronline/pull/14787)) - [GeantRA](https://github.com/GeantRA)
* Deltanet Lambdatrail LT2-S,HS ([#14661](https://github.com/twentyfouronline/twentyfouronline/pull/14661)) - [Bierchermuesli](https://github.com/Bierchermuesli)
* Add support for Battery Recommended Days Remaining ([#14653](https://github.com/twentyfouronline/twentyfouronline/pull/14653)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Webui
* Pseudowires refresh ([#14882](https://github.com/twentyfouronline/twentyfouronline/pull/14882)) - [Bierchermuesli](https://github.com/Bierchermuesli)

#### Alerting
* Jira transport: use template title ([#14883](https://github.com/twentyfouronline/twentyfouronline/pull/14883)) - [not-known](https://github.com/not-known)
* Remove Time Elapsed extra space ([#14880](https://github.com/twentyfouronline/twentyfouronline/pull/14880)) - [electrocret](https://github.com/electrocret)
* Fix Alertlog messaging ([#14861](https://github.com/twentyfouronline/twentyfouronline/pull/14861)) - [electrocret](https://github.com/electrocret)

#### Graphs
* Add graph_stat_percentile_disable config item to disable percentile lines/value printing ([#14887](https://github.com/twentyfouronline/twentyfouronline/pull/14887)) - [VVelox](https://github.com/VVelox)
* Convert NTP freq to use generic_stats ([#14834](https://github.com/twentyfouronline/twentyfouronline/pull/14834)) - [VVelox](https://github.com/VVelox)
* Update fail2ban to have better stat graphs and and fix generic_stats graph.php ([#14818](https://github.com/twentyfouronline/twentyfouronline/pull/14818)) - [VVelox](https://github.com/VVelox)
* Update various device graphs to to have better stats ([#14815](https://github.com/twentyfouronline/twentyfouronline/pull/14815)) - [VVelox](https://github.com/VVelox)

#### Applications
* Add more docker stats ([#14767](https://github.com/twentyfouronline/twentyfouronline/pull/14767)) - [hvanoch](https://github.com/hvanoch)

#### Bug
* SnmpQuery, respect snmp.max_oid ([#14894](https://github.com/twentyfouronline/twentyfouronline/pull/14894)) - [murrant](https://github.com/murrant)
* Add poller_groups (served) to the poller_cluster table ([#14886](https://github.com/twentyfouronline/twentyfouronline/pull/14886)) - [peejaychilds](https://github.com/peejaychilds)
* Actually use the stats graph for ntp-server_freq now, which as missed in #14834 ([#14884](https://github.com/twentyfouronline/twentyfouronline/pull/14884)) - [VVelox](https://github.com/VVelox)
* Add type checking to generic_stats.inc.php for $vars['to'] and $vars['from'] ([#14871](https://github.com/twentyfouronline/twentyfouronline/pull/14871)) - [VVelox](https://github.com/VVelox)
* Fix graphs for a search query ([#14864](https://github.com/twentyfouronline/twentyfouronline/pull/14864)) - [westerterp](https://github.com/westerterp)
* Fix interface parse unsets ([#14860](https://github.com/twentyfouronline/twentyfouronline/pull/14860)) - [electrocret](https://github.com/electrocret)
* Fix dbm calculation to return -60 instead of 0 ([#14858](https://github.com/twentyfouronline/twentyfouronline/pull/14858)) - [electrocret](https://github.com/electrocret)

#### Cleanup
* Store empty user_func as null ([#14900](https://github.com/twentyfouronline/twentyfouronline/pull/14900)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Documentation
* Fix typo in lnms device:add help ([#14937](https://github.com/twentyfouronline/twentyfouronline/pull/14937)) - [arjenz](https://github.com/arjenz)
* Add Azure example configuration for SAML authentication in documentation ([#14870](https://github.com/twentyfouronline/twentyfouronline/pull/14870)) - [fbouynot](https://github.com/fbouynot)

#### Tests
* Re-throw exceptions if we're in CI ([#14890](https://github.com/twentyfouronline/twentyfouronline/pull/14890)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Misc
* Reorder check_icmp command to follow documented usage ([#14910](https://github.com/twentyfouronline/twentyfouronline/pull/14910)) - [mtentilucci](https://github.com/mtentilucci)
* Add multi-PR GitHub-apply ([#14875](https://github.com/twentyfouronline/twentyfouronline/pull/14875)) - [electrocret](https://github.com/electrocret)
* Allows GEO lookup with detailed internal Location information wrapped inside parentheses. ([#14799](https://github.com/twentyfouronline/twentyfouronline/pull/14799)) - [LoveSkylark](https://github.com/LoveSkylark)

#### Dependencies
* PHP dependency update ([#14927](https://github.com/twentyfouronline/twentyfouronline/pull/14927)) - [murrant](https://github.com/murrant)
* Bump phpseclib/phpseclib from 3.0.18 to 3.0.19 ([#14903](https://github.com/twentyfouronline/twentyfouronline/pull/14903)) - [dependabot](https://github.com/apps/dependabot)
* Bump webpack from 5.66.0 to 5.76.1 ([#14901](https://github.com/twentyfouronline/twentyfouronline/pull/14901)) - [dependabot](https://github.com/apps/dependabot)
...
#### Feature
* Indicator on Port Notes tab when Port has notes ([#14923](https://github.com/twentyfouronline/twentyfouronline/pull/14923)) - [electrocret](https://github.com/electrocret)
* Add display query to list_devices function ([#14747](https://github.com/twentyfouronline/twentyfouronline/pull/14747)) - [bonzo81](https://github.com/bonzo81)
...
* Add Cisco Firepower 4112 Support ([#14872](https://github.com/twentyfouronline/twentyfouronline/pull/14872)) - [lukeofthetauri](https://github.com/lukeofthetauri)
* Added PoE controller load and status sensors for Junos devices ([#14868](https://github.com/twentyfouronline/twentyfouronline/pull/14868)) - [bakerds](https://github.com/bakerds)
* Fortigate IPS Intrusions detected stats ([#14857](https://github.com/twentyfouronline/twentyfouronline/pull/14857)) - [electrocret](https://github.com/electrocret)
* Add support for Vsol v1600d EPON OLT ([#14853](https://github.com/twentyfouronline/twentyfouronline/pull/14853)) - [guipoletto](https://github.com/guipoletto)
* Add Montclair EDFA Support ([#14852](https://github.com/twentyfouronline/twentyfouronline/pull/14852)) - [peelman](https://github.com/peelman)
* Fix discovery for apc ats ([#14837](https://github.com/twentyfouronline/twentyfouronline/pull/14837)) - [florisvdk](https://github.com/florisvdk)
* Device - Add support for Scalance SC646-2C ([#14835](https://github.com/twentyfouronline/twentyfouronline/pull/14835)) - [jellejans](https://github.com/jellejans)
* Include Samsung X Series printers ([#14831](https://github.com/twentyfouronline/twentyfouronline/pull/14831)) - [kylegordon](https://github.com/kylegordon)
* Add Fortigate packet loss monitoring for Link-Monitor and SD-WAN ([#14828](https://github.com/twentyfouronline/twentyfouronline/pull/14828)) - [not-known](https://github.com/not-known)
* EdgeOS OLT new sensors and changes ([#14807](https://github.com/twentyfouronline/twentyfouronline/pull/14807)) - [noaheroufus](https://github.com/noaheroufus)
* Update XDP string to exclude modern Cisco lightweight APs from discovery ([#14803](https://github.com/twentyfouronline/twentyfouronline/pull/14803)) - [tristanbob](https://github.com/tristanbob)
* Extend filtering of graphs device_bits on cisco ASA ([#14796](https://github.com/twentyfouronline/twentyfouronline/pull/14796)) - [PipoCanaja](https://github.com/PipoCanaja)
* Changed discovery OID in ets.yaml ([#14795](https://github.com/twentyfouronline/twentyfouronline/pull/14795)) - [da-me](https://github.com/da-me)
* Added Support for SNS-3615-K9 ([#14792](https://github.com/twentyfouronline/twentyfouronline/pull/14792)) - [jaannnis](https://github.com/jaannnis)
* Routeros fix lldp discovery on 7.7+ ([#14791](https://github.com/twentyfouronline/twentyfouronline/pull/14791)) - [knpo](https://github.com/knpo)
* Refactored Juniper SLA to include support for TWAMP and remove ambigu… ([#14787](https://github.com/twentyfouronline/twentyfouronline/pull/14787)) - [GeantRA](https://github.com/GeantRA)
* Fix cisco-flash ([#14772](https://github.com/twentyfouronline/twentyfouronline/pull/14772)) - [electrocret](https://github.com/electrocret)
* Eaton matrix wattage fix ([#14770](https://github.com/twentyfouronline/twentyfouronline/pull/14770)) - [peelman](https://github.com/peelman)
* Add Universal Input Output support for APC ([#14766](https://github.com/twentyfouronline/twentyfouronline/pull/14766)) - [dennypage](https://github.com/dennypage)
* Eltek Enexus; Fix SmartpackS divisor and hardware discovery ([#14762](https://github.com/twentyfouronline/twentyfouronline/pull/14762)) - [peelman](https://github.com/peelman)
* Nokia PMC Microwave Improvements ([#14761](https://github.com/twentyfouronline/twentyfouronline/pull/14761)) - [carbinefreak](https://github.com/carbinefreak)
* Additional sensors ([#14756](https://github.com/twentyfouronline/twentyfouronline/pull/14756)) - [peelman](https://github.com/peelman)
* Add AXOS sensor data for PON Transceivers (the only transceivers Cali… ([#14741](https://github.com/twentyfouronline/twentyfouronline/pull/14741)) - [peelman](https://github.com/peelman)
* Adding discovery of LSI MegaRAID Device Media Errors, Other Errors, a… ([#14729](https://github.com/twentyfouronline/twentyfouronline/pull/14729)) - [bnerickson](https://github.com/bnerickson)
...
* Stop net-snmp from interpreting the octet-string from rttMonEchoAdmin… ([#14676](https://github.com/twentyfouronline/twentyfouronline/pull/14676)) - [not-known](https://github.com/not-known)
* Add state of the Fortigate link monitor health checks ([#14675](https://github.com/twentyfouronline/twentyfouronline/pull/14675)) - [not-known](https://github.com/not-known)
* Adding support for loop-telecom devices ([#14674](https://github.com/twentyfouronline/twentyfouronline/pull/14674)) - [Blinq-SanderBlom](https://github.com/Blinq-SanderBlom)
...
* Use displayname instead of hostname for Device Maintenance Modal Title ([#14681](https://github.com/twentyfouronline/twentyfouronline/pull/14681)) - [electrocret](https://github.com/electrocret)
...
* [About] Open Laravel and RRDtool link in new tab ([#14568](https://github.com/twentyfouronline/twentyfouronline/pull/14568)) - [santiag0z](https://github.com/santiag0z)
* [About] Open the contributor list link in a new tab ([#14553](https://github.com/twentyfouronline/twentyfouronline/pull/14553)) - [santiag0z](https://github.com/santiag0z)
...
* Position the buttons in the center on user preferences page ([#13802](https://github.com/twentyfouronline/twentyfouronline/pull/13802)) - [santiag0z](https://github.com/santiag0z)
...
* Remove Time Elapsed extra space ([#14880](https://github.com/twentyfouronline/twentyfouronline/pull/14880)) - [electrocret](https://github.com/electrocret)
* Fix Alertlog messaging ([#14861](https://github.com/twentyfouronline/twentyfouronline/pull/14861)) - [electrocret](https://github.com/electrocret)
* Fix MS Teams alert transport, correct HTTP header ([#14843](https://github.com/twentyfouronline/twentyfouronline/pull/14843)) - [goebelmeier](https://github.com/goebelmeier)
* Add support for topics ([#14804](https://github.com/twentyfouronline/twentyfouronline/pull/14804)) - [AleksNovak](https://github.com/AleksNovak)
...
* Update fail2ban to have better stat graphs and and fix generic_stats graph.php ([#14818](https://github.com/twentyfouronline/twentyfouronline/pull/14818)) - [VVelox](https://github.com/VVelox)
* Update various device graphs to to have better stats ([#14815](https://github.com/twentyfouronline/twentyfouronline/pull/14815)) - [VVelox](https://github.com/VVelox)
* Update HV::Monitor support to use generic_stats.inc.php ([#14814](https://github.com/twentyfouronline/twentyfouronline/pull/14814)) - [VVelox](https://github.com/VVelox)
* Only show Eth errors when Etherlike is enabled ([#14784](https://github.com/twentyfouronline/twentyfouronline/pull/14784)) - [electrocret](https://github.com/electrocret)
...
#### Applications
* Add a few more graphs for CAPEv2 ([#14813](https://github.com/twentyfouronline/twentyfouronline/pull/14813)) - [VVelox](https://github.com/VVelox)
* CAPEv2 support ([#14801](https://github.com/twentyfouronline/twentyfouronline/pull/14801)) - [VVelox](https://github.com/VVelox)
* Add more docker stats ([#14767](https://github.com/twentyfouronline/twentyfouronline/pull/14767)) - [hvanoch](https://github.com/hvanoch)
...
* Use Oxidized API client and add support for groups on config get ([#14750](https://github.com/twentyfouronline/twentyfouronline/pull/14750)) - [electrocret](https://github.com/electrocret)
...
#### Oxidized
* Show display name in Oxidized config search ([#14800](https://github.com/twentyfouronline/twentyfouronline/pull/14800)) - [electrocret](https://github.com/electrocret)
* Adding Fortigate switches to Oxidized model mapping config ([#14782](https://github.com/twentyfouronline/twentyfouronline/pull/14782)) - [LoveSkylark](https://github.com/LoveSkylark)
...
* Fix interface parse unsets ([#14860](https://github.com/twentyfouronline/twentyfouronline/pull/14860)) - [electrocret](https://github.com/electrocret)
* Fix dbm calculation to return -60 instead of 0 ([#14858](https://github.com/twentyfouronline/twentyfouronline/pull/14858)) - [electrocret](https://github.com/electrocret)
* Revert "Fix entity-state polling/discovery" ([#14811](https://github.com/twentyfouronline/twentyfouronline/pull/14811)) - [murrant](https://github.com/murrant)
* Fix entity-state polling/discovery ([#14793](https://github.com/twentyfouronline/twentyfouronline/pull/14793)) - [fdomain](https://github.com/fdomain)
* Update PingCheck.php to remove duplicate "Device status changed to ... from icmp check." event ([#14785](https://github.com/twentyfouronline/twentyfouronline/pull/14785)) - [MANT5149](https://github.com/MANT5149)
* Fix calculated dbm ([#14771](https://github.com/twentyfouronline/twentyfouronline/pull/14771)) - [electrocret](https://github.com/electrocret)
...
* Fix typo in lnms device:add help ([#14937](https://github.com/twentyfouronline/twentyfouronline/pull/14937)) - [arjenz](https://github.com/arjenz)
* Add Azure example configuration for SAML authentication in documentation ([#14870](https://github.com/twentyfouronline/twentyfouronline/pull/14870)) - [fbouynot](https://github.com/fbouynot)
* Fix Okta image in docs ([#14848](https://github.com/twentyfouronline/twentyfouronline/pull/14848)) - [westerterp](https://github.com/westerterp)
* Change socialite settings URI ([#14845](https://github.com/twentyfouronline/twentyfouronline/pull/14845)) - [fbouynot](https://github.com/fbouynot)
* Fix possible confusion around php-fpm settings ([#14844](https://github.com/twentyfouronline/twentyfouronline/pull/14844)) - [hanserasmus](https://github.com/hanserasmus)
* Use docker compose v2 ([#14841](https://github.com/twentyfouronline/twentyfouronline/pull/14841)) - [MarlinMr](https://github.com/MarlinMr)
* Fix typo in Oauth doc ([#14840](https://github.com/twentyfouronline/twentyfouronline/pull/14840)) - [fbouynot](https://github.com/fbouynot)
* Add Zenduty Integration info to Transports.md docs ([#14826](https://github.com/twentyfouronline/twentyfouronline/pull/14826)) - [zenbeam](https://github.com/zenbeam)
* Update config docs - dump current config ([#14820](https://github.com/twentyfouronline/twentyfouronline/pull/14820)) - [hanserasmus](https://github.com/hanserasmus)
* Add SELinux instructions for nginx monitoring ([#14812](https://github.com/twentyfouronline/twentyfouronline/pull/14812)) - [fbouynot](https://github.com/fbouynot)
* Add SELinux instructions for systemd monitoring ([#14809](https://github.com/twentyfouronline/twentyfouronline/pull/14809)) - [fbouynot](https://github.com/fbouynot)
* Add SELinux instructions for systemd monitoring ([#14806](https://github.com/twentyfouronline/twentyfouronline/pull/14806)) - [fbouynot](https://github.com/fbouynot)
* Debian 11 Sury DPA provides PHP 8.2 ([#14798](https://github.com/twentyfouronline/twentyfouronline/pull/14798)) - [tim427](https://github.com/tim427)
* Update Syslog.md ([#14794](https://github.com/twentyfouronline/twentyfouronline/pull/14794)) - [systeembeheerder](https://github.com/systeembeheerder)
* Update Authentication.md ([#14788](https://github.com/twentyfouronline/twentyfouronline/pull/14788)) - [trs80](https://github.com/trs80)
* Fix Doc Link for Canopsis transport ([#14778](https://github.com/twentyfouronline/twentyfouronline/pull/14778)) - [support-capensis](https://github.com/support-capensis)
* Update ElasticSearch Index pattern for php 8.1 changes ([#14775](https://github.com/twentyfouronline/twentyfouronline/pull/14775)) - [zeroservices](https://github.com/zeroservices)
...
* Fix typo: purge-port.php file name ([#14712](https://github.com/twentyfouronline/twentyfouronline/pull/14712)) - [santiag0z](https://github.com/santiag0z)
...
* DOCS, switch to dark or light mode ([#13953](https://github.com/twentyfouronline/twentyfouronline/pull/13953)) - [santiag0z](https://github.com/santiag0z)
...
* Docs, fix code block in oxidized group ([#13908](https://github.com/twentyfouronline/twentyfouronline/pull/13908)) - [santiag0z](https://github.com/santiag0z)
* [DOC] Fix Code blocks Step 2 Installing Network-WeatherMap ([#13905](https://github.com/twentyfouronline/twentyfouronline/pull/13905)) - [santiag0z](https://github.com/santiag0z)
* [DOC] Styling the .env word quote ([#13889](https://github.com/twentyfouronline/twentyfouronline/pull/13889)) - [santiag0z](https://github.com/santiag0z)
...
#### Translation
* Update zh-TW.json ([#14765](https://github.com/twentyfouronline/twentyfouronline/pull/14765)) - [jasoncheng7115](https://github.com/jasoncheng7115)
* Create files with Traditional Chinese translation ([#14764](https://github.com/twentyfouronline/twentyfouronline/pull/14764)) - [jasoncheng7115](https://github.com/jasoncheng7115)
...
* Reorder check_icmp command to follow documented usage ([#14910](https://github.com/twentyfouronline/twentyfouronline/pull/14910)) - [mtentilucci](https://github.com/mtentilucci)
* Add multi-PR GitHub-apply ([#14875](https://github.com/twentyfouronline/twentyfouronline/pull/14875)) - [electrocret](https://github.com/electrocret)
* Use Device displayname on VRF page ([#14851](https://github.com/twentyfouronline/twentyfouronline/pull/14851)) - [electrocret](https://github.com/electrocret)
* Fix empty output on validation test ([#14822](https://github.com/twentyfouronline/twentyfouronline/pull/14822)) - [hanserasmus](https://github.com/hanserasmus)
* Allows GEO lookup with detailed internal Location information wrapped inside parentheses. ([#14799](https://github.com/twentyfouronline/twentyfouronline/pull/14799)) - [LoveSkylark](https://github.com/LoveSkylark)
...
* Bump phpseclib/phpseclib from 3.0.18 to 3.0.19 ([#14903](https://github.com/twentyfouronline/twentyfouronline/pull/14903)) - [dependabot](https://github.com/apps/dependabot)
* Bump webpack from 5.66.0 to 5.76.1 ([#14901](https://github.com/twentyfouronline/twentyfouronline/pull/14901)) - [dependabot](https://github.com/apps/dependabot)
* Bump symfony/http-kernel from 5.4.16 to 5.4.20 ([#14824](https://github.com/twentyfouronline/twentyfouronline/pull/14824)) - [dependabot](https://github.com/apps/dependabot)
* Bump json5 from 1.0.1 to 1.0.2 ([#14774](https://github.com/twentyfouronline/twentyfouronline/pull/14774)) - [dependabot](https://github.com/apps/dependabot)
