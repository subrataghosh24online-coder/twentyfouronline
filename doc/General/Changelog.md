...
* Device - added support for Tpdin v3 ([#17764](https://github.com/twentyfouronline/twentyfouronline/pull/17764)) - [unwiredhg](https://github.com/unwiredhg)
...
* Cleanup bad data in snmprec files ([#18008](https://github.com/twentyfouronline/twentyfouronline/pull/18008)) - [murrant](https://github.com/murrant)
...
* Remove AlertDB from codebase ([#17775](https://github.com/twentyfouronline/twentyfouronline/pull/17775)) - [laf](https://github.com/laf)
...
* Fix sensor table to link drill-down URL to the specific graph instead of to the device sensor list ([#17722](https://github.com/twentyfouronline/twentyfouronline/pull/17722)) - [nickhilliard](https://github.com/nickhilliard)
...
* Skyhigh web protect Remove quotes from description ([#17861](https://github.com/twentyfouronline/twentyfouronline/pull/17861)) - [PipoCanaja](https://github.com/PipoCanaja)
...
* Depending on the default value of escape is deprecated ([#17845](https://github.com/twentyfouronline/twentyfouronline/pull/17845)) - [Jellyfrog](https://github.com/Jellyfrog)
...
* Fixed discovery logic in equallogic.inc.php ([#17481](https://github.com/twentyfouronline/twentyfouronline/pull/17481)) - [moonpyk](https://github.com/moonpyk)
...
* Update Cisco Platform Detection ([#17342](https://github.com/twentyfouronline/twentyfouronline/pull/17342)) - [MelonicOverlord](https://github.com/MelonicOverlord)
...
* Do not link IPv6 link-locals to a network ([#17386](https://github.com/twentyfouronline/twentyfouronline/pull/17386)) - [murrant](https://github.com/murrant)
* Only apply storage_perc_warn on created ([#17377](https://github.com/twentyfouronline/twentyfouronline/pull/17377)) - [murrant](https://github.com/murrant)
* Fix Yaml data fetch bug ([#17370](https://github.com/twentyfouronline/twentyfouronline/pull/17370)) - [murrant](https://github.com/murrant)
* Fix uncompressed ipv6 for mapped ipv4 ([#17369](https://github.com/twentyfouronline/twentyfouronline/pull/17369)) - [murrant](https://github.com/murrant)
* Fix admin only scope ([#17359](https://github.com/twentyfouronline/twentyfouronline/pull/17359)) - [murrant](https://github.com/murrant)
* Fix installer breakage ([#17350](https://github.com/twentyfouronline/twentyfouronline/pull/17350)) - [murrant](https://github.com/murrant)
* Roles migration ignore duplicate roles ([#17344](https://github.com/twentyfouronline/twentyfouronline/pull/17344)) - [murrant](https://github.com/murrant)
* Ospfv3 rewrite ([#17322](https://github.com/twentyfouronline/twentyfouronline/pull/17322)) - [murrant](https://github.com/murrant)
* Fetch all IPv6 Link-Local ([#17321](https://github.com/twentyfouronline/twentyfouronline/pull/17321)) - [murrant](https://github.com/murrant)
* Bug - Zyxel - Fix for FDB discovery ([#17318](https://github.com/twentyfouronline/twentyfouronline/pull/17318)) - [PipoCanaja](https://github.com/PipoCanaja)
* Fix SnmpResponse getRawWithoutBadLines ([#17315](https://github.com/twentyfouronline/twentyfouronline/pull/17315)) - [murrant](https://github.com/murrant)
* Fix popups background color ([#17278](https://github.com/twentyfouronline/twentyfouronline/pull/17278)) - [murrant](https://github.com/murrant)
* Groups of service template not updating ([#17123](https://github.com/twentyfouronline/twentyfouronline/pull/17123)) - [Vireth4114](https://github.com/Vireth4114)

#### Refactor
* Refactor processors table backend ([#17365](https://github.com/twentyfouronline/twentyfouronline/pull/17365)) - [murrant](https://github.com/murrant)
* Refactor storages table backend ([#17364](https://github.com/twentyfouronline/twentyfouronline/pull/17364)) - [murrant](https://github.com/murrant)
* Refactor sensors table backend ([#17363](https://github.com/twentyfouronline/twentyfouronline/pull/17363)) - [murrant](https://github.com/murrant)
* Remove includes/datastore.inc.php ([#17107](https://github.com/twentyfouronline/twentyfouronline/pull/17107)) - [mpikzink](https://github.com/mpikzink)

#### Cleanup
* Only join the device table when searching ([#17428](https://github.com/twentyfouronline/twentyfouronline/pull/17428)) - [murrant](https://github.com/murrant)
* Fix PHPStan/Larastan errors ([#17398](https://github.com/twentyfouronline/twentyfouronline/pull/17398)) - [Jellyfrog](https://github.com/Jellyfrog)
* Convert route options to fluent methods ([#17395](https://github.com/twentyfouronline/twentyfouronline/pull/17395)) - [Jellyfrog](https://github.com/Jellyfrog)
* Fix test namespaces ([#17339](https://github.com/twentyfouronline/twentyfouronline/pull/17339)) - [murrant](https://github.com/murrant)
* Remove CheckStatus ([#17305](https://github.com/twentyfouronline/twentyfouronline/pull/17305)) - [murrant](https://github.com/murrant)
* Correct casing of SmokepingGenerateCommand ([#17299](https://github.com/twentyfouronline/twentyfouronline/pull/17299)) - [Jellyfrog](https://github.com/Jellyfrog)
* Drop ospfv3_nbrs.ospfv3NbrIfIndex ([#17275](https://github.com/twentyfouronline/twentyfouronline/pull/17275)) - [TheMysteriousX](https://github.com/TheMysteriousX)
* Add missing config definitions and reformat ([#14797](https://github.com/twentyfouronline/twentyfouronline/pull/14797)) - [VVelox](https://github.com/VVelox)

#### Documentation
* Add Debian 13 "Trixie" install instructions ([#17438](https://github.com/twentyfouronline/twentyfouronline/pull/17438)) - [systeembeheerder](https://github.com/systeembeheerder)
* Improved health sensor docs ([#17419](https://github.com/twentyfouronline/twentyfouronline/pull/17419)) - [murrant](https://github.com/murrant)
* Updated Transport docs and some other small tweaks ([#17409](https://github.com/twentyfouronline/twentyfouronline/pull/17409)) - [laf](https://github.com/laf)
* Use SnmpQuery in the docs ([#17388](https://github.com/twentyfouronline/twentyfouronline/pull/17388)) - [murrant](https://github.com/murrant)
* Documentation for SnmpQuery ([#17368](https://github.com/twentyfouronline/twentyfouronline/pull/17368)) - [murrant](https://github.com/murrant)
* Clarify the naming convention for seeder keys. ([#17272](https://github.com/twentyfouronline/twentyfouronline/pull/17272)) - [xorrkaz](https://github.com/xorrkaz)
* Documentation: High Availability setup with redis sentinel ([#17214](https://github.com/twentyfouronline/twentyfouronline/pull/17214)) - [dot-mike](https://github.com/dot-mike)

#### Translation
* Updating minor help popup text grammatical error ([#17347](https://github.com/twentyfouronline/twentyfouronline/pull/17347)) - [clmcavaney](https://github.com/clmcavaney)

#### Tests
* Ospfv3 module has discovery, test it. ([#17440](https://github.com/twentyfouronline/twentyfouronline/pull/17440)) - [murrant](https://github.com/murrant)
* Update super-linter to v7 ([#17300](https://github.com/twentyfouronline/twentyfouronline/pull/17300)) - [Jellyfrog](https://github.com/Jellyfrog)
* Add assertions to mockery shouldReceive's ([#17292](https://github.com/twentyfouronline/twentyfouronline/pull/17292)) - [Jellyfrog](https://github.com/Jellyfrog)
* Remove auto snmpsim and migrate:fresh from phpunit calls ([#17290](https://github.com/twentyfouronline/twentyfouronline/pull/17290)) - [murrant](https://github.com/murrant)
* Use static data providers ([#17286](https://github.com/twentyfouronline/twentyfouronline/pull/17286)) - [murrant](https://github.com/murrant)
* PHPUnit 10 Shift ([#17285](https://github.com/twentyfouronline/twentyfouronline/pull/17285)) - [Jellyfrog](https://github.com/Jellyfrog)

#### Misc
* Sagan logging fix: properly get a list of old instances now to avoid constantly regarding something a new ([#17429](https://github.com/twentyfouronline/twentyfouronline/pull/17429)) - [VVelox](https://github.com/VVelox)
* App Sneck: now includes a easy means to view per check info as well as support debug only items ([#17414](https://github.com/twentyfouronline/twentyfouronline/pull/17414)) - [VVelox](https://github.com/VVelox)
* Add a json(with the capability of including additional info such as ports etc) and headerless mode to report:devices ([#17391](https://github.com/twentyfouronline/twentyfouronline/pull/17391)) - [VVelox](https://github.com/VVelox)
* Ignore errors when collecting snmprecs ([#17382](https://github.com/twentyfouronline/twentyfouronline/pull/17382)) - [murrant](https://github.com/murrant)
* PHP version check in webui ([#17367](https://github.com/twentyfouronline/twentyfouronline/pull/17367)) - [murrant](https://github.com/murrant)
* Revert "Update super-linter to v7" ([#17302](https://github.com/twentyfouronline/twentyfouronline/pull/17302)) - [Jellyfrog](https://github.com/Jellyfrog)
* Throttle dispatcher service's redis reconnection rate ([#16525](https://github.com/twentyfouronline/twentyfouronline/pull/16525)) - [jwestfall69](https://github.com/jwestfall69)

#### Dependencies
* Bump vite from 6.2.5 to 6.2.6 ([#17439](https://github.com/twentyfouronline/twentyfouronline/pull/17439)) - [dependabot](https://github.com/apps/dependabot)
* Bump vite from 6.2.4 to 6.2.5 ([#17401](https://github.com/twentyfouronline/twentyfouronline/pull/17401)) - [dependabot](https://github.com/apps/dependabot)
* Actually require PHP 8.2 ([#17387](https://github.com/twentyfouronline/twentyfouronline/pull/17387)) - [murrant](https://github.com/murrant)
* Bump vite from 6.2.3 to 6.2.4 ([#17378](https://github.com/twentyfouronline/twentyfouronline/pull/17378)) - [dependabot](https://github.com/apps/dependabot)
* Bump vite from 6.2.2 to 6.2.3 ([#17331](https://github.com/twentyfouronline/twentyfouronline/pull/17331)) - [dependabot](https://github.com/apps/dependabot)
...
#### Feature
* IPv6 neighbor discovery ([#17089](https://github.com/twentyfouronline/twentyfouronline/pull/17089)) - [murrant](https://github.com/murrant)
* Add support for OSPFv3 discovery and polling ([#17046](https://github.com/twentyfouronline/twentyfouronline/pull/17046)) - [smos](https://github.com/smos)

#### Device
* Devices - add support for parks-switch ([#17263](https://github.com/twentyfouronline/twentyfouronline/pull/17263)) - [adiaczenko](https://github.com/adiaczenko)
* Fix invalid yaml fs-switch-dc ([#17255](https://github.com/twentyfouronline/twentyfouronline/pull/17255)) - [murrant](https://github.com/murrant)
* Fix for some Cisco Nexus Transceivers ([#17247](https://github.com/twentyfouronline/twentyfouronline/pull/17247)) - [PipoCanaja](https://github.com/PipoCanaja)
* Add RUT956 support with test cases ([#17245](https://github.com/twentyfouronline/twentyfouronline/pull/17245)) - [vhuk](https://github.com/vhuk)
* Add Support for Huawei Optix RTN family ([#17243](https://github.com/twentyfouronline/twentyfouronline/pull/17243)) - [opalivan](https://github.com/opalivan)
* Add cord balance to sentry pdu ([#17242](https://github.com/twentyfouronline/twentyfouronline/pull/17242)) - [dethmetaljeff](https://github.com/dethmetaljeff)
* Updated Flexbng to add individual dhcp pool % ([#17240](https://github.com/twentyfouronline/twentyfouronline/pull/17240)) - [laf](https://github.com/laf)
* Update features discovery for Panduit devices ([#17238](https://github.com/twentyfouronline/twentyfouronline/pull/17238)) - [mivsvit](https://github.com/mivsvit)
* Add support for Cisco Ultra-Reliable Wireless Backhaul APs ([#17232](https://github.com/twentyfouronline/twentyfouronline/pull/17232)) - [rudybroersma](https://github.com/rudybroersma)
* Fix discovery for IOS IE3200 with v17.12 ([#17231](https://github.com/twentyfouronline/twentyfouronline/pull/17231)) - [rudybroersma](https://github.com/rudybroersma)
* Add outlet, temperature, humidity sensor support for Panduit PDUs ([#17221](https://github.com/twentyfouronline/twentyfouronline/pull/17221)) - [mivsvit](https://github.com/mivsvit)
* Added detection for Eltex MES2448 ([#17211](https://github.com/twentyfouronline/twentyfouronline/pull/17211)) - [rhinoau](https://github.com/rhinoau)
* Cisco 400g transceiver ([#17209](https://github.com/twentyfouronline/twentyfouronline/pull/17209)) - [cgriffin352](https://github.com/cgriffin352)
* Eaton sc300 rectifer OS support ([#17201](https://github.com/twentyfouronline/twentyfouronline/pull/17201)) - [mivsvit](https://github.com/mivsvit)
* Correct discovery for Panduit G5 series PDUs ([#17188](https://github.com/twentyfouronline/twentyfouronline/pull/17188)) - [mivsvit](https://github.com/mivsvit)
* Properly display power supply numbers for YunShan OS in twentyfouronline ([#17184](https://github.com/twentyfouronline/twentyfouronline/pull/17184)) - [medeiros405](https://github.com/medeiros405)
* FS S3900 switch sysobject additions ([#17181](https://github.com/twentyfouronline/twentyfouronline/pull/17181)) - [mivsvit](https://github.com/mivsvit)
* Support envPhysicalDescr for junos EVO transceivers ([#17173](https://github.com/twentyfouronline/twentyfouronline/pull/17173)) - [peejaychilds](https://github.com/peejaychilds)
* Fix cisco qos missing title ([#17158](https://github.com/twentyfouronline/twentyfouronline/pull/17158)) - [murrant](https://github.com/murrant)
* Fix for issue #16895 ([#17145](https://github.com/twentyfouronline/twentyfouronline/pull/17145)) - [rudybroersma](https://github.com/rudybroersma)
* Improve Zebra label printer support ([#17106](https://github.com/twentyfouronline/twentyfouronline/pull/17106)) - [takyanagida](https://github.com/takyanagida)

#### Webui
* Updated html/js/pace.min.js to 1.2.4 and added data-pace-options params to layouts/twentyfouronlinev1 ([#17205](https://github.com/twentyfouronline/twentyfouronline/pull/17205)) - [w1ll14m](https://github.com/w1ll14m)
* Fix alert history table verbose detail display ([#17178](https://github.com/twentyfouronline/twentyfouronline/pull/17178)) - [rhinoau](https://github.com/rhinoau)
* Fix 'page' selection for the ARP Search page. $page wasn't supplied to pagination. ([#17175](https://github.com/twentyfouronline/twentyfouronline/pull/17175)) - [w1ll14m](https://github.com/w1ll14m)

#### Alerting
* Adding alert transport for ilert. ([#15880](https://github.com/twentyfouronline/twentyfouronline/pull/15880)) - [lprosch](https://github.com/lprosch)

#### Snmp Traps
* Add trap handlers for loop detection traps ([#17202](https://github.com/twentyfouronline/twentyfouronline/pull/17202)) - [stefanl234](https://github.com/stefanl234)

#### Api
* Added some additional fields to list_alerts api ([#17234](https://github.com/twentyfouronline/twentyfouronline/pull/17234)) - [laf](https://github.com/laf)

#### Bug
* Mempool perc_warn, never update ([#17271](https://github.com/twentyfouronline/twentyfouronline/pull/17271)) - [murrant](https://github.com/murrant)
* Fix wireless sensor thresholds being lost ([#17270](https://github.com/twentyfouronline/twentyfouronline/pull/17270)) - [murrant](https://github.com/murrant)
* LDAP fixes ([#17269](https://github.com/twentyfouronline/twentyfouronline/pull/17269)) - [murrant](https://github.com/murrant)
* Bug - exception in IP::fromHexString ([#17260](https://github.com/twentyfouronline/twentyfouronline/pull/17260)) - [PipoCanaja](https://github.com/PipoCanaja)
* Fix discovery of new devices ([#17252](https://github.com/twentyfouronline/twentyfouronline/pull/17252)) - [murrant](https://github.com/murrant)
* Fix UCD not providing descr sometimes ([#17249](https://github.com/twentyfouronline/twentyfouronline/pull/17249)) - [PipoCanaja](https://github.com/PipoCanaja)
* Skip arp/nd on an interface when the interface is not found ([#17244](https://github.com/twentyfouronline/twentyfouronline/pull/17244)) - [TheMysteriousX](https://github.com/TheMysteriousX)
* Bug - bgp-peers.inc.php - check for null in $bgpPeer ([#17229](https://github.com/twentyfouronline/twentyfouronline/pull/17229)) - [PipoCanaja](https://github.com/PipoCanaja)
* Resolve NAC error polling ([#17227](https://github.com/twentyfouronline/twentyfouronline/pull/17227)) - [kruczek8989](https://github.com/kruczek8989)
* Block polling for new devices to avoid race condition ([#17207](https://github.com/twentyfouronline/twentyfouronline/pull/17207)) - [laf](https://github.com/laf)
* No new devices should not trigger error log ([#17206](https://github.com/twentyfouronline/twentyfouronline/pull/17206)) - [deajan](https://github.com/deajan)
* Remove implied nullables PHP8.4 ([#17193](https://github.com/twentyfouronline/twentyfouronline/pull/17193)) - [murrant](https://github.com/murrant)
* Avoid to update for each discovery ([#17170](https://github.com/twentyfouronline/twentyfouronline/pull/17170)) - [alagoutte](https://github.com/alagoutte)

#### Cleanup
* LDAP fixes for newer PHP versions ([#17257](https://github.com/twentyfouronline/twentyfouronline/pull/17257)) - [murrant](https://github.com/murrant)
* Fix the final implicitly nullable parameters ([#17256](https://github.com/twentyfouronline/twentyfouronline/pull/17256)) - [murrant](https://github.com/murrant)

#### Documentation
* Added Opsgenie EOL date and link to announcement ([#17241](https://github.com/twentyfouronline/twentyfouronline/pull/17241)) - [laf](https://github.com/laf)
* Remove weathermap from docs ([#17239](https://github.com/twentyfouronline/twentyfouronline/pull/17239)) - [murrant](https://github.com/murrant)
* Fix sudo example block for SNMP Extend ([#17212](https://github.com/twentyfouronline/twentyfouronline/pull/17212)) - [rhinoau](https://github.com/rhinoau)
* Doco updates for syslog_hooks lnms config ([#17210](https://github.com/twentyfouronline/twentyfouronline/pull/17210)) - [rhinoau](https://github.com/rhinoau)
* Changed composer install to one line in install docs ([#17191](https://github.com/twentyfouronline/twentyfouronline/pull/17191)) - [laf](https://github.com/laf)
* Update MySQL.md ([#17187](https://github.com/twentyfouronline/twentyfouronline/pull/17187)) - [choicedraught](https://github.com/choicedraught)
* Typo docs ([#17182](https://github.com/twentyfouronline/twentyfouronline/pull/17182)) - [alagoutte](https://github.com/alagoutte)

#### Translation
* Updated pt-BR translations ([#17237](https://github.com/twentyfouronline/twentyfouronline/pull/17237)) - [fabriciotm](https://github.com/fabriciotm)

#### Tests
* Fix dusk tests ([#17258](https://github.com/twentyfouronline/twentyfouronline/pull/17258)) - [murrant](https://github.com/murrant)
* Mock dns resolver for LOC test ([#17196](https://github.com/twentyfouronline/twentyfouronline/pull/17196)) - [murrant](https://github.com/murrant)

#### Misc
* Lnms user:add: add roles when missing ([#17265](https://github.com/twentyfouronline/twentyfouronline/pull/17265)) - [murrant](https://github.com/murrant)
* Update discovery to remove disabled modem sensor in critical state ([#17259](https://github.com/twentyfouronline/twentyfouronline/pull/17259)) - [rudybroersma](https://github.com/rudybroersma)
* Use raw string for Python regex ([#17235](https://github.com/twentyfouronline/twentyfouronline/pull/17235)) - [sthen](https://github.com/sthen)
* Updated leaflet doco for negative coordinates ([#17197](https://github.com/twentyfouronline/twentyfouronline/pull/17197)) - [rhinoau](https://github.com/rhinoau)
* Minor typo in PHP-FPM poller log ([#17195](https://github.com/twentyfouronline/twentyfouronline/pull/17195)) - [runnane](https://github.com/runnane)
* Typo in bdcom transceiver status sensor ([#17189](https://github.com/twentyfouronline/twentyfouronline/pull/17189)) - [mivsvit](https://github.com/mivsvit)
* Exclude irrelevant server state from Panorama servers ([#17180](https://github.com/twentyfouronline/twentyfouronline/pull/17180)) - [rhinoau](https://github.com/rhinoau)

#### Dependencies
* PHP package updates ([#17254](https://github.com/twentyfouronline/twentyfouronline/pull/17254)) - [murrant](https://github.com/murrant)
...
#### Feature
* MAC OUI Vendor lookup ([#17049](https://github.com/twentyfouronline/twentyfouronline/pull/17049)) - [murrant](https://github.com/murrant)

#### Breaking Change
* Storage Module update ([#17024](https://github.com/twentyfouronline/twentyfouronline/pull/17024)) - [murrant](https://github.com/murrant)
* Moved currentInUse from custom table to sensors for Cisco ASA ([#16952](https://github.com/twentyfouronline/twentyfouronline/pull/16952)) - [laf](https://github.com/laf)
* Convert "Recommended Replace Date" from count to runtime sensor ([#16892](https://github.com/twentyfouronline/twentyfouronline/pull/16892)) - [mpikzink](https://github.com/mpikzink)

#### Security
* Web add hosts fixes ([#17162](https://github.com/twentyfouronline/twentyfouronline/pull/17162)) - [murrant](https://github.com/murrant)

#### Device
* Add support for wis bridge ([#17168](https://github.com/twentyfouronline/twentyfouronline/pull/17168)) - [lanbowan-eric](https://github.com/lanbowan-eric)
* Add ArubaCX Transceiver ([#17167](https://github.com/twentyfouronline/twentyfouronline/pull/17167)) - [alagoutte](https://github.com/alagoutte)
* Updated Moxa vendor logo ([#17146](https://github.com/twentyfouronline/twentyfouronline/pull/17146)) - [rhinoau](https://github.com/rhinoau)
* Opengear devices: Add missing sensors & support for new CM8100 model ([#17144](https://github.com/twentyfouronline/twentyfouronline/pull/17144)) - [garryshtern](https://github.com/garryshtern)
* Add power supply status to Yunshan OS (Huawei devices) ([#17143](https://github.com/twentyfouronline/twentyfouronline/pull/17143)) - [gcaceres123](https://github.com/gcaceres123)
* Add power supply status to VRP OS (Huawei devices) ([#17142](https://github.com/twentyfouronline/twentyfouronline/pull/17142)) - [gcaceres123](https://github.com/gcaceres123)
* Fix FS S3400 series polling using fs-bdcom mib ([#17141](https://github.com/twentyfouronline/twentyfouronline/pull/17141)) - [RayaneB75](https://github.com/RayaneB75)
* Added additional snr support ([#17133](https://github.com/twentyfouronline/twentyfouronline/pull/17133)) - [laf](https://github.com/laf)
* Add Palo Alto Panorama Server status ([#17119](https://github.com/twentyfouronline/twentyfouronline/pull/17119)) - [rhinoau](https://github.com/rhinoau)
* Workaround for Routeros LLDP local port index ([#17118](https://github.com/twentyfouronline/twentyfouronline/pull/17118)) - [eskyuu](https://github.com/eskyuu)
* Initial detection for Keenetic devices ([#17117](https://github.com/twentyfouronline/twentyfouronline/pull/17117)) - [rhinoau](https://github.com/rhinoau)
* Imcopower - added alarms and renamed temperature sensor ([#17113](https://github.com/twentyfouronline/twentyfouronline/pull/17113)) - [Martin22](https://github.com/Martin22)
* CIMC C220 M6 Model / Serial / Version Fix ([#17093](https://github.com/twentyfouronline/twentyfouronline/pull/17093)) - [djamp42](https://github.com/djamp42)
* Added support for WitchOS by Teltonika ([#17074](https://github.com/twentyfouronline/twentyfouronline/pull/17074)) - [laf](https://github.com/laf)
* Updated detection for Tachyon devices ([#17073](https://github.com/twentyfouronline/twentyfouronline/pull/17073)) - [laf](https://github.com/laf)
* Add Meraki MR WiFi Frequency polling ([#17069](https://github.com/twentyfouronline/twentyfouronline/pull/17069)) - [rudybroersma](https://github.com/rudybroersma)
* Repair support for Meraki MR28 accesspoints. ([#17065](https://github.com/twentyfouronline/twentyfouronline/pull/17065)) - [rudybroersma](https://github.com/rudybroersma)
* Hiveos has also added IQ Engine to the sysdescription ([#17063](https://github.com/twentyfouronline/twentyfouronline/pull/17063)) - [mjonkers1989](https://github.com/mjonkers1989)
* Additional support for SM-OS ([#17061](https://github.com/twentyfouronline/twentyfouronline/pull/17061)) - [laf](https://github.com/laf)
* Fix cumulus mellanox test data ([#17056](https://github.com/twentyfouronline/twentyfouronline/pull/17056)) - [murrant](https://github.com/murrant)
* Aruba Instant use SnmpQuery ([#17034](https://github.com/twentyfouronline/twentyfouronline/pull/17034)) - [murrant](https://github.com/murrant)
* Convert timos to SnmpQuery ([#17006](https://github.com/twentyfouronline/twentyfouronline/pull/17006)) - [murrant](https://github.com/murrant)
* Adtran ALM series ([#16984](https://github.com/twentyfouronline/twentyfouronline/pull/16984)) - [murrant](https://github.com/murrant)
* Viptela vendor - Processor and Memory fix ([#16983](https://github.com/twentyfouronline/twentyfouronline/pull/16983)) - [Cameron-84](https://github.com/Cameron-84)
* Add voltage and power sensors for Digipower PDUs ([#16803](https://github.com/twentyfouronline/twentyfouronline/pull/16803)) - [gunkaaa](https://github.com/gunkaaa)
* Add authz_status field to Arubaos-CX NAC ([#16453](https://github.com/twentyfouronline/twentyfouronline/pull/16453)) - [JFisherDNS](https://github.com/JFisherDNS)

#### Webui
* Add Device page default to preferred SNMP settings ([#17131](https://github.com/twentyfouronline/twentyfouronline/pull/17131)) - [rhinoau](https://github.com/rhinoau)
* Increased z-index for navbar css to ensure it stays on top. ([#17115](https://github.com/twentyfouronline/twentyfouronline/pull/17115)) - [ssvenn](https://github.com/ssvenn)
* Fix Proxmox module: Correct parameter usage for VM and device ID ([#17114](https://github.com/twentyfouronline/twentyfouronline/pull/17114)) - [georgetasioulis](https://github.com/georgetasioulis)
* Adding the new OPNsense Logo ([#17079](https://github.com/twentyfouronline/twentyfouronline/pull/17079)) - [STRUBartacus](https://github.com/STRUBartacus)
* Update the ordering of sensors for Overview page ([#17038](https://github.com/twentyfouronline/twentyfouronline/pull/17038)) - [laf](https://github.com/laf)
* Handle orphaned ports in port search ([#17037](https://github.com/twentyfouronline/twentyfouronline/pull/17037)) - [murrant](https://github.com/murrant)
* Dark mode for the new Sensor graphs addition ([#17015](https://github.com/twentyfouronline/twentyfouronline/pull/17015)) - [DBardino](https://github.com/DBardino)

#### Alerting
* Failed with 415 with content type not supported issue ([#17110](https://github.com/twentyfouronline/twentyfouronline/pull/17110)) - [jasoncheng7115](https://github.com/jasoncheng7115)
* Updated Grafana transport and docs to support richer information ([#16978](https://github.com/twentyfouronline/twentyfouronline/pull/16978)) - [laf](https://github.com/laf)
* Added ZenDuty Transport ([#16972](https://github.com/twentyfouronline/twentyfouronline/pull/16972)) - [laf](https://github.com/laf)
* Fix Alert diff, Add new AlertStatus changed, Fix AlertLog UI not showing the correct details ([#16313](https://github.com/twentyfouronline/twentyfouronline/pull/16313)) - [Calvario](https://github.com/Calvario)

#### Graphs
* Graph has trouble detecting the range if the sensor is constant ([#17096](https://github.com/twentyfouronline/twentyfouronline/pull/17096)) - [mpikzink](https://github.com/mpikzink)
* Fix multi port graph ([#17057](https://github.com/twentyfouronline/twentyfouronline/pull/17057)) - [murrant](https://github.com/murrant)

#### Maps
* Fullscreen map fixes ([#17136](https://github.com/twentyfouronline/twentyfouronline/pull/17136)) - [dot-mike](https://github.com/dot-mike)
* Map not working on device overview with custom engine ([#17134](https://github.com/twentyfouronline/twentyfouronline/pull/17134)) - [dot-mike](https://github.com/dot-mike)
* Add custom maps node warning state display ([#17036](https://github.com/twentyfouronline/twentyfouronline/pull/17036)) - [rhinoau](https://github.com/rhinoau)

#### Discovery
* Fix module override submodules ([#17081](https://github.com/twentyfouronline/twentyfouronline/pull/17081)) - [murrant](https://github.com/murrant)
* Work around bad bridge-mib implementations ([#17030](https://github.com/twentyfouronline/twentyfouronline/pull/17030)) - [murrant](https://github.com/murrant)

#### Polling
* Better handle issues with ipmitool/freeipmi so we try other types as … ([#17066](https://github.com/twentyfouronline/twentyfouronline/pull/17066)) - [visbits](https://github.com/visbits)

#### Bug
* Fix wlanAPChInterferenceIndex formula. Fixes Numeric value out of range: 1264 Out of range value for column 'interference' ([#17171](https://github.com/twentyfouronline/twentyfouronline/pull/17171)) - [w1ll14m](https://github.com/w1ll14m)
* Fix storage_perc_warn not being applied to new storages ([#17104](https://github.com/twentyfouronline/twentyfouronline/pull/17104)) - [murrant](https://github.com/murrant)
* Fix port churn port assoc mode if is non-existent field ([#17103](https://github.com/twentyfouronline/twentyfouronline/pull/17103)) - [murrant](https://github.com/murrant)
* Fix poller submodule support ([#17102](https://github.com/twentyfouronline/twentyfouronline/pull/17102)) - [murrant](https://github.com/murrant)
* Fix OS override in device settings ([#17095](https://github.com/twentyfouronline/twentyfouronline/pull/17095)) - [murrant](https://github.com/murrant)
* Re-add ifIndex index to ports table ([#17077](https://github.com/twentyfouronline/twentyfouronline/pull/17077)) - [murrant](https://github.com/murrant)
* Replace use of $config with Config::get() in poll-billing ([#17072](https://github.com/twentyfouronline/twentyfouronline/pull/17072)) - [laf](https://github.com/laf)
* Fix error in arp-table module ([#17031](https://github.com/twentyfouronline/twentyfouronline/pull/17031)) - [murrant](https://github.com/murrant)

#### Refactor
* Remove ObjectCache notifications page ([#17100](https://github.com/twentyfouronline/twentyfouronline/pull/17100)) - [murrant](https://github.com/murrant)
* Convert Wireless to a modern module ([#17086](https://github.com/twentyfouronline/twentyfouronline/pull/17086)) - [murrant](https://github.com/murrant)
* Remove snmp_getnext_multi() ([#17048](https://github.com/twentyfouronline/twentyfouronline/pull/17048)) - [murrant](https://github.com/murrant)
* Get_device_id_by_port_id(x) =\> PortCache::get() ([#16969](https://github.com/twentyfouronline/twentyfouronline/pull/16969)) - [mpikzink](https://github.com/mpikzink)
* Zeropad() =\> Str::padLeft() ([#16960](https://github.com/twentyfouronline/twentyfouronline/pull/16960)) - [mpikzink](https://github.com/mpikzink)
* Improve logging for use of values from SNMP;  improve logging for determining multiplier/divisor from YAML ([#16949](https://github.com/twentyfouronline/twentyfouronline/pull/16949)) - [gunkaaa](https://github.com/gunkaaa)
* Showconfig.inc.php changed svn_log() and svn_diff() to Process() ([#16483](https://github.com/twentyfouronline/twentyfouronline/pull/16483)) - [mggaskill](https://github.com/mggaskill)

#### Cleanup
* Add enable_syslog_hooks config defaults ([#17130](https://github.com/twentyfouronline/twentyfouronline/pull/17130)) - [rhinoau](https://github.com/rhinoau)
* Sizeof() =\> count() ([#17108](https://github.com/twentyfouronline/twentyfouronline/pull/17108)) - [mpikzink](https://github.com/mpikzink)
* Remove unused files ([#17101](https://github.com/twentyfouronline/twentyfouronline/pull/17101)) - [murrant](https://github.com/murrant)
* Remove Create sensor to state index ([#17097](https://github.com/twentyfouronline/twentyfouronline/pull/17097)) - [mpikzink](https://github.com/mpikzink)
* Check if json file is existing when saving test data ([#17087](https://github.com/twentyfouronline/twentyfouronline/pull/17087)) - [murrant](https://github.com/murrant)
* Remove echo calls from sensors polling ([#17076](https://github.com/twentyfouronline/twentyfouronline/pull/17076)) - [murrant](https://github.com/murrant)
* Remove echo from ports polling module ([#17075](https://github.com/twentyfouronline/twentyfouronline/pull/17075)) - [murrant](https://github.com/murrant)
* Remove some unused functions (part 2) ([#17013](https://github.com/twentyfouronline/twentyfouronline/pull/17013)) - [mpikzink](https://github.com/mpikzink)
* Remove unix agent global usage ([#17003](https://github.com/twentyfouronline/twentyfouronline/pull/17003)) - [murrant](https://github.com/murrant)

#### Documentation
* InfluxDBv2.md Fix ([#17124](https://github.com/twentyfouronline/twentyfouronline/pull/17124)) - [slashdoom](https://github.com/slashdoom)
* Update Custom-Graphs.md ([#17084](https://github.com/twentyfouronline/twentyfouronline/pull/17084)) - [slashdoom](https://github.com/slashdoom)
* Update Macros.md ([#17064](https://github.com/twentyfouronline/twentyfouronline/pull/17064)) - [dot-mike](https://github.com/dot-mike)
* Lnms dev:check modules only ([#17044](https://github.com/twentyfouronline/twentyfouronline/pull/17044)) - [murrant](https://github.com/murrant)
* Api force_add requires credentials ([#17019](https://github.com/twentyfouronline/twentyfouronline/pull/17019)) - [murrant](https://github.com/murrant)
* Doc application and RRDCached, refactoring and formatting ([#16920](https://github.com/twentyfouronline/twentyfouronline/pull/16920)) - [Torstein-Eide](https://github.com/Torstein-Eide)

#### Translation
* Settings typo ([#17083](https://github.com/twentyfouronline/twentyfouronline/pull/17083)) - [electrocret](https://github.com/electrocret)
* German typo correction for "channel" ([#17011](https://github.com/twentyfouronline/twentyfouronline/pull/17011)) - [Galileo77](https://github.com/Galileo77)

#### Tests
* Qos test fix ([#17050](https://github.com/twentyfouronline/twentyfouronline/pull/17050)) - [eskyuu](https://github.com/eskyuu)
* Wireless tests order data ([#17016](https://github.com/twentyfouronline/twentyfouronline/pull/17016)) - [murrant](https://github.com/murrant)
* Fix Tests for PHP IPv6 reserved handling changes ([#17009](https://github.com/twentyfouronline/twentyfouronline/pull/17009)) - [murrant](https://github.com/murrant)

#### Misc
* Updated Siklu vendor logo ([#17120](https://github.com/twentyfouronline/twentyfouronline/pull/17120)) - [rhinoau](https://github.com/rhinoau)
* Update detection for Planet WDAP devices ([#17116](https://github.com/twentyfouronline/twentyfouronline/pull/17116)) - [rhinoau](https://github.com/rhinoau)
* Fix comment syntax in rrdcached.service ([#17109](https://github.com/twentyfouronline/twentyfouronline/pull/17109)) - [trwhiteaker](https://github.com/trwhiteaker)
* Add support for Cisco CIMC State Sensors ([#17085](https://github.com/twentyfouronline/twentyfouronline/pull/17085)) - [djamp42](https://github.com/djamp42)
* Correct accidental addition of $agent_raw variable in unix-agent.inc.php ([#17060](https://github.com/twentyfouronline/twentyfouronline/pull/17060)) - [Sweeny42](https://github.com/Sweeny42)
* Storage deleted removal notification and alert rule ([#17055](https://github.com/twentyfouronline/twentyfouronline/pull/17055)) - [murrant](https://github.com/murrant)
* Add enable_proxmox to config defs ([#17032](https://github.com/twentyfouronline/twentyfouronline/pull/17032)) - [murrant](https://github.com/murrant)
* Remove some unused functions ([#17005](https://github.com/twentyfouronline/twentyfouronline/pull/17005)) - [mpikzink](https://github.com/mpikzink)
* StringHelper::shortenText(x) =\> Str::limit(x) ([#16973](https://github.com/twentyfouronline/twentyfouronline/pull/16973)) - [mpikzink](https://github.com/mpikzink)
* Allow ifIndex swaps during port discovery ([#16686](https://github.com/twentyfouronline/twentyfouronline/pull/16686)) - [eskyuu](https://github.com/eskyuu)

#### Internal Features
* Show unused cached snmp queries ([#17004](https://github.com/twentyfouronline/twentyfouronline/pull/17004)) - [murrant](https://github.com/murrant)
* Implement PortCache ([#17002](https://github.com/twentyfouronline/twentyfouronline/pull/17002)) - [murrant](https://github.com/murrant)

#### Mibs
* Update SCHLEIFENBAUER Mibs ([#17067](https://github.com/twentyfouronline/twentyfouronline/pull/17067)) - [mjonkers1989](https://github.com/mjonkers1989)

#### Dependencies
* Bump elliptic from 6.6.0 to 6.6.1 ([#17169](https://github.com/twentyfouronline/twentyfouronline/pull/17169)) - [dependabot](https://github.com/apps/dependabot)
* Update ENTITY and fix consequences ([#17147](https://github.com/twentyfouronline/twentyfouronline/pull/17147)) - [PipoCanaja](https://github.com/PipoCanaja)
* Update PHP dependencies ([#17059](https://github.com/twentyfouronline/twentyfouronline/pull/17059)) - [murrant](https://github.com/murrant)
...
#### Breaking Change
* Remove wrong netvision sensors ([#16943](https://github.com/twentyfouronline/twentyfouronline/pull/16943)) - [mpikzink](https://github.com/mpikzink)
* Add datetime and level to twentyfouronline.log ([#16330](https://github.com/twentyfouronline/twentyfouronline/pull/16330)) - [Calvario](https://github.com/Calvario)

#### Device
* Timos MPLS ignore bad rows ([#16997](https://github.com/twentyfouronline/twentyfouronline/pull/16997)) - [murrant](https://github.com/murrant)
* Junos bgp non-null fallbacks for columns that are not nullable ([#16993](https://github.com/twentyfouronline/twentyfouronline/pull/16993)) - [murrant](https://github.com/murrant)
* Fix fs-centec bias thresholds ([#16990](https://github.com/twentyfouronline/twentyfouronline/pull/16990)) - [murrant](https://github.com/murrant)
* Fix Junos BGP polling ([#16988](https://github.com/twentyfouronline/twentyfouronline/pull/16988)) - [murrant](https://github.com/murrant)
* Added additional voltage sensor for RouterOS ([#16979](https://github.com/twentyfouronline/twentyfouronline/pull/16979)) - [laf](https://github.com/laf)
* Horizon Quantum Device Support ([#16970](https://github.com/twentyfouronline/twentyfouronline/pull/16970)) - [slashdoom](https://github.com/slashdoom)
* Add support for UTAX printers ([#16951](https://github.com/twentyfouronline/twentyfouronline/pull/16951)) - [dko-strd](https://github.com/dko-strd)
* Stulz wib8000 fixes ([#16948](https://github.com/twentyfouronline/twentyfouronline/pull/16948)) - [nickhilliard](https://github.com/nickhilliard)
* Fix some issues with aix returning "NULL" ([#16947](https://github.com/twentyfouronline/twentyfouronline/pull/16947)) - [murrant](https://github.com/murrant)
* Added some additional ip pool sensors ([#16946](https://github.com/twentyfouronline/twentyfouronline/pull/16946)) - [laf](https://github.com/laf)
* Corrected index for EXOS sensors ([#16928](https://github.com/twentyfouronline/twentyfouronline/pull/16928)) - [laf](https://github.com/laf)
* New HW revision of 7130L ([#16919](https://github.com/twentyfouronline/twentyfouronline/pull/16919)) - [garryshtern](https://github.com/garryshtern)
* Added DHCP Count for RouterOS (Mikrotik) ([#16913](https://github.com/twentyfouronline/twentyfouronline/pull/16913)) - [laf](https://github.com/laf)
* DELL drac: Move the remaining inc.php sensors to YAML ([#16912](https://github.com/twentyfouronline/twentyfouronline/pull/16912)) - [mpikzink](https://github.com/mpikzink)
* Cisco SIP voice count sensor ([#16902](https://github.com/twentyfouronline/twentyfouronline/pull/16902)) - [PipoCanaja](https://github.com/PipoCanaja)
* Procurve handle HPE rebrand ([#16897](https://github.com/twentyfouronline/twentyfouronline/pull/16897)) - [TotalGriffLock](https://github.com/TotalGriffLock)
* Skip creation of "Stack Ring - Redundant" sensor for Cisco StackWise Virtual ([#16890](https://github.com/twentyfouronline/twentyfouronline/pull/16890)) - [makriska](https://github.com/makriska)
* Added sensor monitoring for IBM 3584 Tape Library ([#16884](https://github.com/twentyfouronline/twentyfouronline/pull/16884)) - [MelonicOverlord](https://github.com/MelonicOverlord)
* Tachyon - Added wireless interface to ports ([#16867](https://github.com/twentyfouronline/twentyfouronline/pull/16867)) - [Martin22](https://github.com/Martin22)
* Fix for Cisco Transceivers ([#16856](https://github.com/twentyfouronline/twentyfouronline/pull/16856)) - [PipoCanaja](https://github.com/PipoCanaja)
* Add new vendor bitstream ([#16850](https://github.com/twentyfouronline/twentyfouronline/pull/16850)) - [kruczek8989](https://github.com/kruczek8989)
* Additional HPE Procurve Hardware State Data ([#16843](https://github.com/twentyfouronline/twentyfouronline/pull/16843)) - [eg2965](https://github.com/eg2965)
* Fix for FortiGate discovery - Issue ID #16544 ([#16753](https://github.com/twentyfouronline/twentyfouronline/pull/16753)) - [rudybroersma](https://github.com/rudybroersma)
* Initial detection with USB port detection ([#16718](https://github.com/twentyfouronline/twentyfouronline/pull/16718)) - [mpikzink](https://github.com/mpikzink)
* Nokia ISAM added extra context to also snmpwalk the ihub for uplink ports ([#16676](https://github.com/twentyfouronline/twentyfouronline/pull/16676)) - [rinsekloek](https://github.com/rinsekloek)
* Support for ESPHOME OS ([#16571](https://github.com/twentyfouronline/twentyfouronline/pull/16571)) - [JacobErnst98](https://github.com/JacobErnst98)
* Add support for Cisco ISA devices ([#16300](https://github.com/twentyfouronline/twentyfouronline/pull/16300)) - [samburney](https://github.com/samburney)
* Support for Ubiquiti UISP Fiber OLT XGS ([#15742](https://github.com/twentyfouronline/twentyfouronline/pull/15742)) - [pozar](https://github.com/pozar)

#### Webui
* Fix time intervals sometimes being wrong ([#16995](https://github.com/twentyfouronline/twentyfouronline/pull/16995)) - [murrant](https://github.com/murrant)
* Fix rrdgraph comment typo ([#16956](https://github.com/twentyfouronline/twentyfouronline/pull/16956)) - [ZPrimed](https://github.com/ZPrimed)
* Added time period names: threeday, tenday ([#16932](https://github.com/twentyfouronline/twentyfouronline/pull/16932)) - [takyanagida](https://github.com/takyanagida)
* Fixed port error red flag staying after error correction on FDB table and ARP table ([#16907](https://github.com/twentyfouronline/twentyfouronline/pull/16907)) - [takyanagida](https://github.com/takyanagida)
* Improve url validation check ([#16900](https://github.com/twentyfouronline/twentyfouronline/pull/16900)) - [murrant](https://github.com/murrant)
* Fix routes display ([#16898](https://github.com/twentyfouronline/twentyfouronline/pull/16898)) - [murrant](https://github.com/murrant)

#### Alerting
* Rename Jira Service Managment transport (#16195) ([#16967](https://github.com/twentyfouronline/twentyfouronline/pull/16967)) - [jakejakejakejakejakejake](https://github.com/jakejakejakejakejakejake)
* Fix Graph problems in Mail ([#16918](https://github.com/twentyfouronline/twentyfouronline/pull/16918)) - [mpikzink](https://github.com/mpikzink)
* Update queuemanager.py: Single element args tuple breaks alerts.php running ([#16873](https://github.com/twentyfouronline/twentyfouronline/pull/16873)) - [r-duran](https://github.com/r-duran)

#### Graphs
* Dark mode for the new Sensor graphs ([#16985](https://github.com/twentyfouronline/twentyfouronline/pull/16985)) - [mpikzink](https://github.com/mpikzink)

#### Snmp Traps
* Add support for Cisco-NS-MIB traps ([#16944](https://github.com/twentyfouronline/twentyfouronline/pull/16944)) - [adamsweet](https://github.com/adamsweet)
* Add HWG Poseidon-MIB traps ([#16934](https://github.com/twentyfouronline/twentyfouronline/pull/16934)) - [adamsweet](https://github.com/adamsweet)
* Add Axis camera alarm traps ([#16925](https://github.com/twentyfouronline/twentyfouronline/pull/16925)) - [adamsweet](https://github.com/adamsweet)

#### Discovery
* Extend STP discovery on Cisco devices + test fix for #15742 ([#16887](https://github.com/twentyfouronline/twentyfouronline/pull/16887)) - [PipoCanaja](https://github.com/PipoCanaja)

#### Polling
* Ensure ordering of poller modules ([#16929](https://github.com/twentyfouronline/twentyfouronline/pull/16929)) - [murrant](https://github.com/murrant)

#### Bug
* Fix SLA incomplete snmpwalk replies ([#16939](https://github.com/twentyfouronline/twentyfouronline/pull/16939)) - [PipoCanaja](https://github.com/PipoCanaja)
* OrderBy snmp_index because qos.title is not unique ([#16938](https://github.com/twentyfouronline/twentyfouronline/pull/16938)) - [PipoCanaja](https://github.com/PipoCanaja)
* Null strings in Junos Transceivers code ([#16937](https://github.com/twentyfouronline/twentyfouronline/pull/16937)) - [PipoCanaja](https://github.com/PipoCanaja)

#### Refactor
* Additional type declarations to Eventlog ([#16968](https://github.com/twentyfouronline/twentyfouronline/pull/16968)) - [mpikzink](https://github.com/mpikzink)
* Cast_number() =\> Number::cast() ([#16963](https://github.com/twentyfouronline/twentyfouronline/pull/16963)) - [mpikzink](https://github.com/mpikzink)
* Get_dev_attribs($device_id) =\> Use the Model Method ([#16961](https://github.com/twentyfouronline/twentyfouronline/pull/16961)) - [mpikzink](https://github.com/mpikzink)
* Accesspoint_by_id(x) =\> AccessPoint::find(x) ([#16958](https://github.com/twentyfouronline/twentyfouronline/pull/16958)) - [mpikzink](https://github.com/mpikzink)
* Refractor some Helpers part2 ([#16935](https://github.com/twentyfouronline/twentyfouronline/pull/16935)) - [mpikzink](https://github.com/mpikzink)
* Refractor some Helpers ([#16926](https://github.com/twentyfouronline/twentyfouronline/pull/16926)) - [mpikzink](https://github.com/mpikzink)

#### Documentation
* Update authentication docs ([#16996](https://github.com/twentyfouronline/twentyfouronline/pull/16996)) - [murrant](https://github.com/murrant)
* Update Install-twentyfouronline.md ([#16982](https://github.com/twentyfouronline/twentyfouronline/pull/16982)) - [btriller](https://github.com/btriller)
* Add php-fpm requirements on Fedora for Applications ([#16933](https://github.com/twentyfouronline/twentyfouronline/pull/16933)) - [fbouynot](https://github.com/fbouynot)
* Update Dispatcher-Service.md ([#16921](https://github.com/twentyfouronline/twentyfouronline/pull/16921)) - [trakennedy](https://github.com/trakennedy)
* Update config.php.default ([#16896](https://github.com/twentyfouronline/twentyfouronline/pull/16896)) - [dlangille](https://github.com/dlangille)
* Update Authentication.md ([#16894](https://github.com/twentyfouronline/twentyfouronline/pull/16894)) - [systeembeheerder](https://github.com/systeembeheerder)
* Plugin docs udpate ([#16891](https://github.com/twentyfouronline/twentyfouronline/pull/16891)) - [murrant](https://github.com/murrant)

#### Translation
* Add multiple translation files for zh-TW. ([#16941](https://github.com/twentyfouronline/twentyfouronline/pull/16941)) - [jasoncheng7115](https://github.com/jasoncheng7115)
* Zh-TW components.php ([#16931](https://github.com/twentyfouronline/twentyfouronline/pull/16931)) - [jasoncheng7115](https://github.com/jasoncheng7115)
* Zh-TW port.php ([#16930](https://github.com/twentyfouronline/twentyfouronline/pull/16930)) - [jasoncheng7115](https://github.com/jasoncheng7115)
* Update zh-TW.json ([#16924](https://github.com/twentyfouronline/twentyfouronline/pull/16924)) - [jasoncheng7115](https://github.com/jasoncheng7115)
* Map.php - Traditional Chinese Translation ([#16906](https://github.com/twentyfouronline/twentyfouronline/pull/16906)) - [jasoncheng7115](https://github.com/jasoncheng7115)

#### Internal Features
* Snmpsim extra check ([#16936](https://github.com/twentyfouronline/twentyfouronline/pull/16936)) - [murrant](https://github.com/murrant)

#### Dependencies
* Bump tecnickcom/tcpdf from 6.7.7 to 6.8.0 ([#16914](https://github.com/twentyfouronline/twentyfouronline/pull/16914)) - [dependabot](https://github.com/apps/dependabot)

##[Old Changelogs](https://github.com/twentyfouronline/twentyfouronline/tree/master/doc/General/Changelogs)
