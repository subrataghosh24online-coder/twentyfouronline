...
trait SyncsModels
{
     ...
     * Model must implement \twentyfouronline\Interfaces\Models\Keyable interface
     *
     * @param  \Illuminate\Database\Eloquent\Model  $parentModel
     * @param  string  $relationship
     * @param  \Illuminate\Support\Collection<Keyable>  $models  \twentyfouronline\Interfaces\Models\Keyable
     * @return Collection
     */
     ...
     *
     * @param  Collection  $existing  \twentyfouronline\Interfaces\Models\Keyable
     * @param  Collection  $discovered  \twentyfouronline\Interfaces\Models\Keyable
     * @return Collection
     */
