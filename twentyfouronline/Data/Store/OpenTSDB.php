 ...
 * @copyright  2017 Yacine Benamsili <https://github.com/yac01/twentyfouronline.git>
...
class OpenTSDB extends BaseDatastore
{
    ...
    {
        parent::__construct();
        $host = twentyfouronlineConfig::get('opentsdb.host');
        $port = twentyfouronlineConfig::get('opentsdb.port', 2181);
        try {
    ...
    {
        return twentyfouronlineConfig::get('opentsdb.enable', false);
    }
}
