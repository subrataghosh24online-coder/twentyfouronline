...
class Graphite extends BaseDatastore
{
    ...
    {
        parent::__construct();
        $host = twentyfouronlineConfig::get('graphite.host');
        $port = twentyfouronlineConfig::get('graphite.port', 2003);
        try {
        ...
        $this->prefix = twentyfouronlineConfig::get('graphite.prefix', '');
    }
    ...
    {
        return twentyfouronlineConfig::get('graphite.enable', false);
    }
