...
namespace twentyfouronline\Data\Graphing;
...
class GraphParameters
{
    ...
    public function __construct(array $vars)
    {
        ...
        $this->font = twentyfouronlineConfig::get('mono_font');
    ...
    private function graphColors(): array
    {
        ...
        $def_colors = twentyfouronlineConfig::get($style == 'dark' ? 'rrdgraph_def_text_dark' : 'rrdgraph_def_text');
        $def_font = ltrim(twentyfouronlineConfig::get($style == 'dark' ? 'rrdgraph_def_text_color_dark' : 'rrdgraph_def_text_color'), '#');
