...
namespace twentyfouronline\RRD;

use App\Facades\twentyfouronlineConfig;
use twentyfouronline\Exceptions\InvalidRrdTypeException;
...
class RrdDefinition
{
    ...
    public function addDataset($name, $type, $min = null, $max = null, $heartbeat = null, $source_ds = null, $source_file = null)
    {
        ...
        $this->dataSets[$name] = [
            ...
            'hb' => is_null($heartbeat) ? twentyfouronlineConfig::get('rrd.heartbeat') : $heartbeat,
