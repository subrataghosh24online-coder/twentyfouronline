...
namespace twentyfouronline\Polling;
...
class ConnectivityHelper
{
    ...
    {
        $command = [twentyfouronlineConfig::get('traceroute', 'traceroute'), '-q', '1', '-w', '1', '-I', $this->target];
    ...
    {
        return twentyfouronlineConfig::get('icmp_check') && ! ($this->device->exists && $this->device->getAttrib('override_icmp_disable') === 'true');
    }
    ...
    private function updateAvailability(bool $current_status): void
    {
        ...
        if (twentyfouronlineConfig::get('graphing.availability_consider_maintenance')
