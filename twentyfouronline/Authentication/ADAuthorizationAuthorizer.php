...
class ADAuthorizationAuthorizer extends MysqlAuthorizer
{
    ...
    public function __construct()
    {
        ...
        if (twentyfouronlineConfig::has('auth_ad_check_certificates') &&
            twentyfouronlineConfig::get('auth_ad_check_certificates') == 0) {
        ...
        if (twentyfouronlineConfig::has('auth_ad_binduser') && twentyfouronlineConfig::has('auth_ad_bindpassword')) {
            ...
            if (! ldap_bind($this->ldap_connection, twentyfouronlineConfig::get('auth_ad_binduser') . '@' . twentyfouronlineConfig::get('auth_ad_domain'), twentyfouronlineConfig::get('auth_ad_bindpassword'))) {
    ...
    public function getRoles(string $username): array|false
    {
        ...
        // collect all roles
        $auth_ad_groups = twentyfouronlineConfig::get('auth_ad_groups');
