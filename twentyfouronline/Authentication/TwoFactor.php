...
class TwoFactor
{
    ...
    {
        $title = 'twentyfouronline:' . urlencode($username);

        return $counter ?
            "otpauth://hotp/$title?issuer=twentyfouronline&counter=1&secret=$key" : // counter based
            "otpauth://totp/$title?issuer=twentyfouronline&secret=$key"; // time based
    }
}
