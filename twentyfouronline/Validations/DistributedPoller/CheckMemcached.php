...
namespace twentyfouronline\Validations\DistributedPoller;

use App\Facades\twentyfouronlineConfig;
use Illuminate\Support\Facades\Config;
use twentyfouronline\Interfaces\Validation;
...
class CheckMemcached implements Validation
{
    ...
    {
        if (! twentyfouronlineConfig::get('distributed_poller_memcached_host')) {
        ...
        if (! twentyfouronlineConfig::get('distributed_poller_memcached_port')) {
        ...
        $connection = @fsockopen(twentyfouronlineConfig::get('distributed_poller_memcached_host'), twentyfouronlineConfig::get('distributed_poller_memcached_port'));
    ...
    {
        return twentyfouronlineConfig::get('distributed_poller') && Config::get('cache.default') == 'memcached';
    }
}
