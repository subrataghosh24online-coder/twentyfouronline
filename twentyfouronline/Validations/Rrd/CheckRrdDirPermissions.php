...
namespace twentyfouronline\Validations\Rrd;
...
class CheckRrdDirPermissions implements Validation
{
    ...
    public function validate(): ValidationResult
    {
        ...
        if ($dir_stat[4] == 0 || $dir_stat[5] == 0) {
            return ValidationResult::warn(trans('validation.validations.rrd.CheckRrdDirPermissions.fail_root'),
                sprintf('chown %s:%s %s', twentyfouronlineConfig::get('user'), twentyfouronlineConfig::get('group'), $rrd_dir)
            );
        }
    ...
    {
        return ! twentyfouronlineConfig::get('rrdcached');
    }
}
