...
class CheckPythonWrapper implements \twentyfouronline\Interfaces\Validation
{
    /** @var bool */
    ...
    public function validate(): ValidationResult
    {
        ...
        $cron = twentyfouronlineConfig::locateBinary('cron');
    ...
    private function wrapperCronEnabled(): bool
    {
        ...
        $files[] = '/etc/crontab';
        $files[] = '/var/spool/cron/crontabs/twentyfouronline';
