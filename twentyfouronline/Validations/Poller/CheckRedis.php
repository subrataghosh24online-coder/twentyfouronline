...
class CheckRedis implements \twentyfouronline\Interfaces\Validation
{
    /**
     * @inheritDoc
     */
    public function validate(): ValidationResult
    {
        ...
        if ($driver == 'redis' || (\App\Facades\twentyfouronlineConfig::get('distributed_poller') && \App\Models\PollerCluster::isActive()->count() > 2)) {
