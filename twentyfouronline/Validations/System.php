...
class System extends BaseValidation
{
    ...
    public function validate(Validator $validator): void
    {
        ...
        $rotation_file = '/etc/logrotate.d/twentyfouronline';
        if (! file_exists($rotation_file) && ! twentyfouronlineConfig::get('installed_from_package')) {
            $validator->warn('Log rotation not enabled, could cause disk space issues', "sudo cp $install_dir/misc/twentyfouronline.logrotate $rotation_file");
        }
    }
}
