...
class User extends BaseValidation
{
    ...
    public function validate(Validator $validator): void
    {
        ...
        $lnms_username = \config('twentyfouronline.user');
        $lnms_groupname = \config('twentyfouronline.group');
        ...
        if ($lnms_username) {
            $dir = twentyfouronlineConfig::get('install_dir');
            $log_dir = twentyfouronlineConfig::get('log_dir', "$dir/logs");
            $rrd_dir = twentyfouronlineConfig::get('rrd_dir', "$dir/rrd");
            ...
            if (! twentyfouronlineConfig::get('installed_from_package')) {
                ...
                if (! empty($find_result)) {
                    ...
                    $ignore_files = [
                        ...
                        "$dir/.pki/", // ignore files/folders created by setting the twentyfouronline home directory to the install directory
                    ];
            ...
            $validator->warn("You don't have twentyfouronline_USER set, this most likely needs to be set to 'twentyfouronline'");
        }
    }
}
