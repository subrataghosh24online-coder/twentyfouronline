...
class Configuration extends BaseValidation
{
    ...
    {
        // Test transports
        if (twentyfouronlineConfig::get('alerts.email.enable') == true) {
            $validator->warn('You have the old alerting system enabled - this is to be deprecated on the 1st of June 2015: https://groups.google.com/forum/#!topic/twentyfouronline-project/1llxos4m0p4');
        }
        ...
        if (twentyfouronlineConfig::has('validation.encryption.test')) {
            try {
                if (\Crypt::decryptString(twentyfouronlineConfig::get('validation.encryption.test')) !== 'twentyfouronline') {
            ...
            twentyfouronlineConfig::persist('validation.encryption.test', \Crypt::encryptString('twentyfouronline'));
        }
    }
