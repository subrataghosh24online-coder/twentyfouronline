...
namespace twentyfouronline\Validations\Database;
    ...
    public function validate(): ValidationResult
    {
        ...
        if (empty($collation) !== true) {
            return ValidationResult::fail(
                ...
                'Check https://community.twentyfouronline.org/t/new-default-database-charset-collation/14956 for info on how to fix.'
            )->setFixer(__CLASS__);
        }
        ...
        if (empty($collation_tables) !== true) {
            return ValidationResult::fail('MySQL tables collation is wrong: ')
                ->setFix('Check https://community.twentyfouronline.org/t/new-default-database-charset-collation/14956 for info on how to fix.')
                ->setFixer(__CLASS__)
