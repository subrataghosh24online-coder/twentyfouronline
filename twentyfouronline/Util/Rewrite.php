...
class Rewrite
{
    ...
    public static function location($location)
    {
        ...
        if (is_array(twentyfouronlineConfig::get('location_map_regex'))) {
            foreach (twentyfouronlineConfig::get('location_map_regex') as $reg => $val) {
        ...
        if (is_array(twentyfouronlineConfig::get('location_map_regex_sub'))) {
            foreach (twentyfouronlineConfig::get('location_map_regex_sub') as $reg => $val) {
                if (preg_match($reg, $location)) {
        ...
        if (twentyfouronlineConfig::has("location_map.$location")) {
            $location = twentyfouronlineConfig::get("location_map.$location");
        }
