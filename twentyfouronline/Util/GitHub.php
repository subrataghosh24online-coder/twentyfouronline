...
class GitHub
{
    ...
    protected $markdown;
    protected $github = 'https://api.github.com/repos/twentyfouronline/twentyfouronline';
    ...
    public function getPullRequests($date, $after = null)
    {
        ...
        $query = <<<GRAPHQL
{
  search(query: "repo:twentyfouronline/twentyfouronline is:pr is:merged merged:>=$date", type: ISSUE, first: 100$after) {
    edges {
      node {
        ... on PullRequest {
          number
...
GRAPHQL;
    ...
    {
        $version_file = 'twentyfouronline/Util/Version.php';
