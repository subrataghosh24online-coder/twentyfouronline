...
use twentyfouronline\Modules\LegacyModule;
...
class Module
{
    ...
    {
        if (class_exists(StringHelpers::toClass($module_name, '\\twentyfouronline\\Modules\\'))) {
            return true;
        }

        return twentyfouronlineConfig::has('discovery_modules.' . $module_name) || twentyfouronlineConfig::has('poller_modules.' . $module_name);
    }

    public static function fromName(string $module_name): \twentyfouronline\Interfaces\Module
    {
        $module_class = StringHelpers::toClass($module_name, '\\twentyfouronline\\Modules\\');
    ...
    public static function pollingStatus(string $module_name, Device $device, ?bool $manual = null): ModuleStatus
    {
        return new ModuleStatus(
            twentyfouronlineConfig::get("poller_modules.$module_name"),
            twentyfouronlineConfig::get("os.{$device->os}.poller_modules.$module_name"),
