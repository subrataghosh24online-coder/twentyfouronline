 ...
 * Version.php
 *
 * Get version info about twentyfouronline and various components/dependencies
 *
...
class Version
{
    ...
    {
        return new static(app('twentyfouronline-config'));
    }
    ...
    public static function registerAboutCommand(): void
    {
        ...
        AboutCommand::add('twentyfouronline', fn () => [
