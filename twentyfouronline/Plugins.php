...
class Plugins
{
    ...
    public static function start()
    {
        ...
        self::$plugins = [];
        $plugin_dir = twentyfouronlineConfig::get('plugin_dir');
    ...
    {
        chdir(twentyfouronlineConfig::get('install_dir') . '/html');
        ...
        chdir(twentyfouronlineConfig::get('install_dir'));
    ...
    {
        $ns_prefix = 'twentyfouronline\\Plugins\\';
    ...
    public static function scanNew()
    {
        ...
        if (file_exists(twentyfouronlineConfig::get('plugin_dir'))) {
            $plugin_files = array_diff(scandir(twentyfouronlineConfig::get('plugin_dir')), ['..', '.']);
            $plugin_files = array_diff($plugin_files, Plugin::versionOne()->pluck('plugin_name')->toArray());
            foreach ($plugin_files as $name) {
                if (is_dir(twentyfouronlineConfig::get('plugin_dir') . '/' . $name)
                    && is_file(twentyfouronlineConfig::get('plugin_dir') . '/' . $name . '/' . $name . '.php')) {
    ...
    public static function scanRemoved()
    {
        ...
        if (file_exists(twentyfouronlineConfig::get('plugin_dir'))) {
            $plugin_files = array_diff(scandir(twentyfouronlineConfig::get('plugin_dir')), ['.', '..', '.gitignore']);
