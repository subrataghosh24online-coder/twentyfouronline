...
use twentyfouronline\Interfaces\Discovery\QosDiscovery;
use twentyfouronline\Interfaces\Discovery\Sensors\WirelessCcqDiscovery;
use twentyfouronline\Interfaces\Discovery\Sensors\WirelessClientsDiscovery;
use twentyfouronline\Interfaces\Discovery\Sensors\WirelessDistanceDiscovery;
...
use twentyfouronline\Interfaces\Discovery\Sensors\WirelessQualityDiscovery;
use twentyfouronline\Interfaces\Discovery\Sensors\WirelessRateDiscovery;
...
use twentyfouronline\Interfaces\Discovery\TransceiverDiscovery;
...
use twentyfouronline\Interfaces\Polling\QosPolling;
        ...
        $qos->each(function (Qos $thisQos, int $key) use ($poll_time, $treeNames, $treeBytes, $treeDrops, $simpleNames, $simpleBytesIn, $simpleBytesOut, $simpleDropsIn, $simpleDropsOut) {
            switch ($thisQos->type) {
                ...
                case 'routeros_simple':
                    ...
                    break;
                default:
                    echo 'Queue type ' . $thisQos->type . " has not been implmeneted in twentyfouronline/OS/Routeros.php\n";
            }
        });
    }
