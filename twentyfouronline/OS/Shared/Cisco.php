...
use twentyfouronline\Interfaces\Discovery\SlaDiscovery;
...
use twentyfouronline\Interfaces\Polling\NacPolling;
use twentyfouronline\Interfaces\Polling\QosPolling;
use twentyfouronline\Interfaces\Polling\SlaPolling;
    ...
    public function pollQos($qos)
    {
        ...
        foreach ($qos as $thisQos) {
            if ($thisQos->type == 'cisco_cbqos_classmap') {
                ...
                d_echo('Cisco CBQoS ' . $thisQos->type . ' not implemented in twentyfouronline/OS/Shared/Cisco.php');
            }
        }
    }
