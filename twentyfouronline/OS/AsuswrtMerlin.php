    ...
    WirelessSnrDiscovery
{
    ...
    /**
     * Retrieve (and explode to array) list of network interfaces, and desired display name in twentyfouronline.
     ...
     * type - string, matching to twentyfouronline documentation => https://docs.twentyfouronline.org/Developing/os/Wireless-Sensors/
    ...
    {
        // Initialize needed variables, and get interfaces (actual network name, and twentyfouronline name)
        $sensors = [];
