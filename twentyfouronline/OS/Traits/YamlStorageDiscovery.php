...
use twentyfouronline\Discovery\Yaml\IndexField;
use twentyfouronline\Discovery\Yaml\LiteralField;
use twentyfouronline\Discovery\Yaml\OidField;
use twentyfouronline\Discovery\Yaml\YamlDiscoveryField;
use twentyfouronline\Discovery\YamlDiscoveryDefinition;
...
trait YamlStorageDiscovery
{
    ...
    public function discoverYamlStorage(): Collection
    {
        $discovery = YamlDiscoveryDefinition::make(Storage::class)
            ...
            ->addField(new YamlDiscoveryField('warn_percent', 'storage_perc_warn', \twentyfouronlineConfig::get('storage_perc_warn', 80)))
