...
use twentyfouronline\Interfaces\Discovery\DiscoveryModule;
use twentyfouronline\Interfaces\Polling\PollerModule;
use twentyfouronline\Interfaces\Polling\ProcessorPolling;
use twentyfouronline\Model;
...
class Processor extends Model implements DiscoveryModule, PollerModule, DiscoveryItem
{
    ...
    public static function discover(
        ...
        $proc->processor_perc_warn = $warn_percent ?? twentyfouronlineConfig::get('processor_perc_warn', 75);
