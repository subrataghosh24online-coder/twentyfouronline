...
use twentyfouronline\Interfaces\Exceptions\UpgradeableException;
use Throwable;
...
class FilePermissionsException extends \Exception implements UpgradeableException
{
    ...
    {
        $log_file = config('app.log') ?: twentyfouronlineConfig::get('log_file', base_path('logs/twentyfouronline.log'));
    ...
    private function generateCommands($log_file): array
    {
        ...
        $group = config('twentyfouronline.group');
        $install_dir = base_path();
        $commands = [];
        $dirs = [
            base_path('bootstrap/cache'),
            base_path('storage'),
            twentyfouronlineConfig::get('log_dir', base_path('logs')),
            twentyfouronlineConfig::get('rrd_dir', base_path('rrd')),
        ];
        ...
        // check if webserver is in the twentyfouronline group
