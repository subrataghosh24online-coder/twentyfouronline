...
use twentyfouronline\Interfaces\Discovery\VminfoDiscovery;
use twentyfouronline\Interfaces\Polling\VminfoPolling;
use twentyfouronline\OS;
use twentyfouronline\Polling\ModuleStatus;

class Vminfo implements \twentyfouronline\Interfaces\Module
{
    use SyncsModels;
    ...
    public function shouldDiscover(OS $os, ModuleStatus $status): bool
    {
        ...
        return $status->isEnabledAndDeviceUp($os->getDevice(), check_snmp: ! twentyfouronlineConfig::get('enable_libvirt')) && $os instanceof VminfoDiscovery;
    }
