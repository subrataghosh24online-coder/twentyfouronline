...
class LegacyModule implements Module
{
    ...
    {
        if (! \twentyfouronline\Util\Module::legacyDiscoveryExists($this->name)) {
    ...
    {
        if (! \twentyfouronline\Util\Module::legacyPollingExists($this->name)) {
            Log::error("Module $this->name does not exist, please remove it from your configuration");
    ...
    {
        if ($type == 'discovery' && ! \twentyfouronline\Util\Module::legacyDiscoveryExists($this->name)) {
            return null;
        }
        if ($type == 'poller' && ! \twentyfouronline\Util\Module::legacyPollingExists($this->name)) {
            return null;
        }
