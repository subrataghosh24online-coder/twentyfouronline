...
class Wireless implements Module
{
    ...
    {
        $submodules = twentyfouronlineConfig::get('discovery_submodules.wireless', $this->types);
        ...
        foreach ($types as $type) {
            ...
            $sensors = collect($sensors)->map(function (\twentyfouronline\Device\WirelessSensor $legacy) {
    ...
    public function poll(OS $os, DataStorageInterface $datastore): void
    {
        ...
        $submodules = twentyfouronlineConfig::get('poller_submodules.wireless', []);
    ...
    {
        return StringHelpers::toClass("wireless $type discovery", 'twentyfouronline\\Interfaces\\Discovery\\Sensors\\');
    }
    ...
    {
        return StringHelpers::toClass("wireless $type polling", 'twentyfouronline\\Interfaces\\Polling\\Sensors\\');
    }
