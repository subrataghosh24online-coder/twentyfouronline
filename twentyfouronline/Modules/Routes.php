...
use twentyfouronline\Exceptions\TooManyRoutes;
use twentyfouronline\Interfaces\Data\DataStorageInterface;
use twentyfouronline\Interfaces\Discovery\RouteDiscovery;
...
class Routes implements Module
{
    ...
    public function discover(OS $os): void
    {
        ...
        $max_routes = (int) twentyfouronlineConfig::get('routes_max_number') ?: 1000;
