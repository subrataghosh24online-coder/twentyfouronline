 ...
 * Messagebird.php
 *
 * twentyfouronline Messagebird API Tranport
 *
 ...
 *
 * Messagebird will return 201 status if the text message was send if no 201 twentyfouronline will log the full error
 *
