...
namespace twentyfouronline\Interfaces\Authentication;
...
interface Authorizer
{
    ...
    /**
     * Indicates if the authentication happens within the twentyfouronline process, or external to it.
     * If the former, twentyfouronline provides a login form, and the user must supply the username. If the latter, the authenticator supplies it via getExternalUsername() without user interaction.
     * This is an important distinction, because at the point this is called if the authentication happens out of process, the user is already authenticated and twentyfouronline must not display a login form - even if something fails.
     *
     * @return bool
     */
